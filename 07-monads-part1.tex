...
\begin{itemize}
\item Each \emph{generator line} finally computes a container of \emph{the}
\emph{same} type
...
\item Traverse a ``solution tree''tem Traverse a ``solution tree'' with DFS and filter out incorrect solutions
\begin{itemize}
...
Examples: see code
\begin{enumerate}
\item Implement a tree of properties
