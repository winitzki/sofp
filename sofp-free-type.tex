...
\chapter{``Free'' type constructions}

\section{Slides}

\subsection{The interpreter pattern I. Expression trees}
...
\subsection{The interpreter pattern II. Variable binding}
...
\subsection{The interpreter pattern III. Type safety}
...
\subsection{The interpreter pattern IV. Cleaning up the DSL}
...
\subsection{The interpreter pattern V. Define \texttt{Monad}-like methods}
...
\subsection{The interpreter pattern VI. Refactoring to an abstract DSL}
...
\subsection{The interpreter pattern VII. Handling errors}
...
A{]} \ensuremath{\Rightarrow} b match \{ case Bind(p, f) \ensuremath{\Rightarrow} }}{\footnotesize\par}
...
\subsection{Monad laws for DSL programs}
...
\subsection{Free constructions in mathematics: Example I}

Consider the Russian letter \foreignlanguage{russian}{ц} (ts\`{e})
...
\textbf{Reduced encoding}, as a ``smart'' structure: List(\shui,\shui,\foreignlanguage{russian}{ц},\shui,\foreignlanguage{russian}{ц})

Implement $a\cdot b$ by concatenating the lists (more expensive)


\subsection{Free constructions in mathematics: Example II}
...
\subsection{Worked example I: Free semigroup}
...
\subsection{Worked example II: Free monoid}
...
\subsection{Mapping a free semigroup to different targets}
...
\subsection{Church encoding II: Disjunction types}
...
A, Z{]}(f: Z \ensuremath{\Rightarrow} A)(ffz: FF{[}F, Z{]}) extends
FF{[}F, A{]}}}{\footnotesize\par}
...
\subsection{Church encoding IV: Recursive types and type constructors}
...
\subsection{Church encoding V: Type classes}
...
\subsection{Recipes for encoding free typeclass instances}
...
\subsection{Worked example V: Free pointed functor}
...
\subsection{Worked example VI: Free filterable functor}
...
\subsection{Worked example VII: Free monad}
...
\subsection{Worked example VIII: Free applicative functor}
...
\subsection{Combining different free typeclasses}
...
$\text{run}^{P}g\circ f=\text{run}^{Q}\left(g\circ f\right)$, however,
