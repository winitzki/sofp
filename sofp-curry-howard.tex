...
\begin{equation}
\left(A\vee B\right)\wedge C=\left(A\wedge C\right)\vee\left(B\vee C\right)\quad.\label{eq:ch-example-distributive-1}
\end{equation}
...
\]
 Another example of a logical identity is the associativity law for
conjunction,
\[
