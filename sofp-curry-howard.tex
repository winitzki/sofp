...
of fully parametric functions, such as\inputencoding{latin9}
\begin{lstlisting}
def before[A, B, C](f: A => B, g: B => C): A => C = { x => g(f(x)) }
\end{lstlisting}
\inputencoding{utf8}We have also seen in Section~\ref{subsec:Deriving-a-function's}
...
To begin, consider the Scala code of a fully parametric function,\inputencoding{latin9}
\begin{lstlisting}
def f[A, B, ...]: ... = {
  ...
...
\end{lstlisting}
\inputencoding{utf8}If this program compiles without type errors, it means that the types
match and, in particular, that the function \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
is able to compute a value \inputencoding{latin9}\lstinline!x!\inputencoding{utf8}
of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}.
...
the fully parametric function \inputencoding{latin9}\lstinline!fmap!\inputencoding{utf8}
described in Section~\ref{subsec:Disjunctive-Example-option-1} cannot
compute any values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8},\inputencoding{latin9}
\begin{lstlisting}
def fmap[A, B](f: A => B): Option[A] => Option[B] = {
  val x: A = ??? // Cannot compute x here!
  ... }
\end{lstlisting}
\inputencoding{utf8}The reason is that a fully parametric function cannot compute values
of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8} from
scratch, without using previously given values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}
and without applying a function that returns values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}.
In \inputencoding{latin9}\lstinline!fmap!\inputencoding{utf8}, no
values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}
are given as arguments; the given function \inputencoding{latin9}\lstinline!f: A => B!\inputencoding{utf8}
returns values of type \inputencoding{latin9}\lstinline!B!\inputencoding{utf8}
and not \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}.
The code of \inputencoding{latin9}\lstinline!fmap!\inputencoding{utf8}
must do pattern matching on \inputencoding{latin9}\lstinline!oa:Option[A]!\inputencoding{utf8},
yielding two cases:\inputencoding{latin9}
\begin{lstlisting}
def fmap[A, B](f: A => B): Option[A] => Option[B] = {
  case None       => 
    val x: A = ??? // Cannot compute x here!
...
\end{lstlisting}
\inputencoding{utf8}Since the case \inputencoding{latin9}\lstinline!None!\inputencoding{utf8}
does not contain any values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8},
we are unable to compute a value \inputencoding{latin9}\lstinline!x!\inputencoding{utf8}
in that scope (as long as \inputencoding{latin9}\lstinline!fmap!\inputencoding{utf8}
remains a fully parametric function). Being able to compute \inputencoding{latin9}\lstinline!x:A!\inputencoding{utf8}
``within the body of the function'' means that, if needed, function
should be able to return \inputencoding{latin9}\lstinline!x!\inputencoding{utf8}
as a result value. This requires being able to compute \inputencoding{latin9}\lstinline!x!\inputencoding{utf8}
in \emph{all} cases, not just within one part of the \inputencoding{latin9}\lstinline!match!\inputencoding{utf8}
expression. 

The body of \inputencoding{latin9}\lstinline!fmap!\inputencoding{utf8}
also cannot compute any values of type \inputencoding{latin9}\lstinline!B!\inputencoding{utf8}.
Since no arguments of type \inputencoding{latin9}\lstinline!B!\inputencoding{utf8}
are given, the only way of obtaining a value of type \inputencoding{latin9}\lstinline!B!\inputencoding{utf8}
would be to apply the function \inputencoding{latin9}\lstinline!f: A => B!\inputencoding{utf8}
to \emph{some} value of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8};
but we just saw that the body of \inputencoding{latin9}\lstinline!fmap!\inputencoding{utf8}
cannot compute any values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}.
...
\end{lstlisting}
\inputencoding{utf8}The body of \inputencoding{latin9}\lstinline!before!\inputencoding{utf8}
may only use the arguments \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!g!\inputencoding{utf8}. It is
possible to obtain a value of type \inputencoding{latin9}\lstinline!A => C!\inputencoding{utf8}
by composing \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!g!\inputencoding{utf8}, but
it is impossible to compute a value \inputencoding{latin9}\lstinline!h!\inputencoding{utf8}
of type \inputencoding{latin9}\lstinline!C => A!\inputencoding{utf8},
no matter what code we try to write for computing \inputencoding{latin9}\lstinline!h!\inputencoding{utf8}
via \inputencoding{latin9}\lstinline!f!\inputencoding{utf8} and \inputencoding{latin9}\lstinline!g!\inputencoding{utf8}.
The reason is that the body of \inputencoding{latin9}\lstinline!before!\inputencoding{utf8}
has no given values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}
and no functions that return values of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8},
so a nameless function such as \inputencoding{latin9}\lstinline!(c:C) => ???!\inputencoding{utf8}
cannot implement its return value of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}.
Since a fully parametric function cannot create values of an arbitrary
type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8} from
scratch, we see no possibility of computing \inputencoding{latin9}\lstinline!h!\inputencoding{utf8}
within the body of \inputencoding{latin9}\lstinline!before!\inputencoding{utf8}.

Can we prove rigorously that a value of type \inputencoding{latin9}\lstinline!C => A!\inputencoding{utf8}
cannot be computed within the body of \inputencoding{latin9}\lstinline!before!\inputencoding{utf8}?
...
statements such as ``\emph{a fully parametric function} \inputencoding{latin9}\lstinline!before!\inputencoding{utf8}
\emph{can compute a value of type} \inputencoding{latin9}\lstinline!C => A!\inputencoding{utf8}''
...
functional languages: the \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
type, the void type (called \inputencoding{latin9}\lstinline!Nothing!\inputencoding{utf8}
...
\paragraph{Rule for \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
type}

The \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8} type
has only a single value \inputencoding{latin9}\lstinline!()!\inputencoding{utf8},
and this value can be \emph{always} computed since it does not depend
on having any previous data:\inputencoding{latin9}
\begin{lstlisting}
def f[...]: ... = {
  ...
...
\end{lstlisting}
\inputencoding{utf8}So the proposition ${\cal CH}($\inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}$)$
is always true. In the type notation, the \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
type is denoted by $\bbnum 1$.

Named \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
types\index{unit type!named} also have a single value that is always
possible to compute. For example,\inputencoding{latin9}
\begin{lstlisting}
final case class N1()
\end{lstlisting}
\inputencoding{utf8}defines a named \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
type, and it can be computed as\inputencoding{latin9}
\begin{lstlisting}
val x: N1 = N1()
\end{lstlisting}
\inputencoding{utf8}So, the proposition ${\cal CH}($\inputencoding{latin9}\lstinline!N1!\inputencoding{utf8}$)$
is always true. Named \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
types are denoted by $\bbnum 1$, just as the \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
type itself.

\paragraph{Rule for the void type}

The Scala type \inputencoding{latin9}\lstinline!Nothing!\inputencoding{utf8}
has no values, so the proposition ${\cal CH}($\inputencoding{latin9}\lstinline!Nothing!\inputencoding{utf8}$)$
is always false. The type \inputencoding{latin9}\lstinline!Nothing!\inputencoding{utf8}
is denoted by $\bbnum 0$ in the type notation.

\paragraph{Rule for primitive types}

For a specific primitive (or library-defined) type such as \inputencoding{latin9}\lstinline!Int!\inputencoding{utf8}
...
we could use any constant value, for example:\inputencoding{latin9}
\begin{lstlisting}
def f[...]: ... {
   ...
...
To compute a value of a tuple type \inputencoding{latin9}\lstinline!(A, B)!\inputencoding{utf8}
requires to compute a value of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}
\emph{and} a value of type \inputencoding{latin9}\lstinline!B!\inputencoding{utf8}.
This is expressed by the logic formula ${\cal CH}($\inputencoding{latin9}\lstinline!(A, B)!\inputencoding{utf8}$)={\cal CH}(A)\wedge{\cal CH}(B)$.
A similar formula holds for case classes, as Eq.~(\ref{eq:curry-howard-example-case-class})
shows. In the type notation, the tuple \inputencoding{latin9}\lstinline!(A, B)!\inputencoding{utf8}
is written as $A\times B$. Tuples and case classes with more than
two parts are denoted similarly as $A\times B\times...\times C$.
For example, the Scala definition\inputencoding{latin9}
\begin{lstlisting}
case class Person(firstName: String, lastName: String, age: Int)
\end{lstlisting}
\inputencoding{utf8}is written in the type notation as $\text{String}\times\text{String}\times\text{Int}$.
...
we have the logical formula ${\cal CH}($\inputencoding{latin9}\lstinline!Either[A, B]!\inputencoding{utf8}$)={\cal CH}(A)\vee{\cal CH}(B)$.
In the type notation, the Scala type \inputencoding{latin9}\lstinline!Either[A, B]!\inputencoding{utf8}
is written as $A+B$. A longer example: the Scala definition\inputencoding{latin9}
\begin{lstlisting}
...
\end{lstlisting}
\inputencoding{utf8}is translated to the type notation as
\[
...
Consider now a function type such as \inputencoding{latin9}\lstinline!A => B!\inputencoding{utf8}.
...
\end{lstlisting}
\inputencoding{utf8}The inner scope of the function needs to compute a value of type $B$,
and the given value \inputencoding{latin9}\lstinline!a:A!\inputencoding{utf8}
...
Consider a function with type parameters, e.g.\inputencoding{latin9}
\begin{lstlisting}
def f[A, B]: A => (A => B) => B = x => g => g(x)
\end{lstlisting}
\inputencoding{utf8}Being able to define the body of such a function is equivalent to
being able to compute a value of type \inputencoding{latin9}\lstinline!A => (A => B) => B!\inputencoding{utf8}
for \emph{all} possible types \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!B!\inputencoding{utf8} at once.
...
\]
 The code notation for the parameterized function \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
is 
\[
...
for the type of the function \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
looks like this,\inputencoding{latin9}
\begin{lstlisting}
type F[A, B] = A => (A => B) => B
def f[A, B]: F[A, B] = x => g => g(x)
\end{lstlisting}
\inputencoding{utf8}This is written in the type notation as
\begin{align*}
...
In Scala 3, the function \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
can be written as a value via the syntax\inputencoding{latin9}
\begin{lstlisting}
val f: [A, B] => A => (A => B) => B =
  [A, B] => (x: A) => (g: A => B) => g(x)
\end{lstlisting}
\inputencoding{utf8}This syntax corresponds more closely to the mathematical notation
shown above.
...
\hline 
\hline 
{\small{}type parameter} \inputencoding{latin9}\lstinline!A!\inputencoding{utf8} & $A$ & ${\cal CH}(A)$\tabularnewline
\hline 
{\small{}tuple} \inputencoding{latin9}\lstinline!(A, B)!\inputencoding{utf8} & $A\times B$ & ${\cal CH}(A)$ $\wedge$ ${\cal CH}(B)$\tabularnewline
\hline 
{\small{}disjunctive type} \inputencoding{latin9}\lstinline!Either[A, B]!\inputencoding{utf8} & $A+B$ & ${\cal CH}(A)$ $\vee$ ${\cal CH}(B)$\tabularnewline
\hline 
{\small{}function type} \inputencoding{latin9}\lstinline!A => B!\inputencoding{utf8} & $A\Rightarrow B$ & ${\cal CH}(A)$ $\Rightarrow$ ${\cal CH}(B)$\tabularnewline
\hline 
\inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}, {\small{}or
``named''} \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
{\small{}types} & $\bbnum 1$ & {\small{}always} \emph{True}\tabularnewline
\hline 
\inputencoding{latin9}\lstinline!Nothing!\inputencoding{utf8} {\small{}(the
void type)} & $\bbnum 0$ & {\small{}always} \emph{False}\tabularnewline
\hline 
{\small{}parameterized method} \inputencoding{latin9}\lstinline!def f[A]: F[A]!\inputencoding{utf8} & $f^{A}:F^{A}$ & $\forall A.\,{\cal CH}(F^{A})$\tabularnewline
\hline 
{\small{}parameterized value (Scala 3)} \inputencoding{latin9}\lstinline![A] => F[A]!\inputencoding{utf8} & $\forall A.\,F^{A}$ & $\forall A.\,{\cal CH}(F^{A})$\tabularnewline
\hline 
\end{tabular}
\par\end{centering}
...
Define a function \inputencoding{latin9}\lstinline!delta!\inputencoding{utf8}
taking an argument \inputencoding{latin9}\lstinline!x!\inputencoding{utf8}
and returning the pair \inputencoding{latin9}\lstinline!(x, x)!\inputencoding{utf8}.
Derive the most general type for this function. Write the type signature
of \inputencoding{latin9}\lstinline!delta!\inputencoding{utf8} in
the type notation, and translate it into a ${\cal CH}$-proposition.
Simplify the ${\cal CH}$-proposition if possible.

\subparagraph{Solution}

Begin by writing the code of the function:\inputencoding{latin9}
\begin{lstlisting}
def delta(x: ...) = (x, x)
\end{lstlisting}
\inputencoding{utf8}To derive the most general type for \inputencoding{latin9}\lstinline!delta!\inputencoding{utf8},
first assume \inputencoding{latin9}\lstinline!x:A!\inputencoding{utf8},
where \inputencoding{latin9}\lstinline!A!\inputencoding{utf8} is
a type parameter; then the tuple \inputencoding{latin9}\lstinline!(x, x)!\inputencoding{utf8}
has type \inputencoding{latin9}\lstinline!(A, A)!\inputencoding{utf8}.
We do not see any constraints on the type parameter \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}.
So the type parameter represents an arbitrary type and needs to be
added to the type signature of \inputencoding{latin9}\lstinline!delta!\inputencoding{utf8}:\inputencoding{latin9}
\begin{lstlisting}
def delta[A](x: A): (A, A) = (x, x)
\end{lstlisting}
\inputencoding{utf8}We find that the most general type of \inputencoding{latin9}\lstinline!delta!\inputencoding{utf8}
is \inputencoding{latin9}\lstinline!A => (A, A)!\inputencoding{utf8}.

It is convenient to use the letter $\Delta$ for the function \inputencoding{latin9}\lstinline!delta!\inputencoding{utf8}.
...
The standard disjunctive types \inputencoding{latin9}\lstinline!Option[A]!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!Either[A, B]!\inputencoding{utf8}
are written in the type notation as
\begin{align*}
\text{Option}^{A} & \triangleq\bbnum 1+A\quad,\\
\text{Either}^{A,B} & \triangleq A+B\quad.
\end{align*}
The type \inputencoding{latin9}\lstinline!Option[A]!\inputencoding{utf8}
has two disjoint cases, \inputencoding{latin9}\lstinline!None!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!Some[A]!\inputencoding{utf8}.
The value \inputencoding{latin9}\lstinline!None!\inputencoding{utf8}
is a ``\index{named unit type}named \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}'',
which is denoted by $\bbnum 1$. The case class \inputencoding{latin9}\lstinline!Some[A]!\inputencoding{utf8}
contains a single value of type $A$. So, the type notation for \inputencoding{latin9}\lstinline!Option[A]!\inputencoding{utf8}
is $\bbnum 1+A$.

\subsubsection{Example \label{subsec:Example-ch-notation-function-1-a}\ref{subsec:Example-ch-notation-function-1-a}}

The Scala definition of the disjunctive type\inputencoding{latin9}
\begin{lstlisting}
...
\end{lstlisting}
\inputencoding{utf8}is written in the type notation as
\[
...
and get the three nameless tuples \inputencoding{latin9}\lstinline!(String, String)!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!(String)!\inputencoding{utf8}, and
\inputencoding{latin9}\lstinline!(Long)!\inputencoding{utf8}. Each
...
The parameterized disjunctive type generalizing \inputencoding{latin9}\lstinline!Either!\inputencoding{utf8},\inputencoding{latin9}
\begin{lstlisting}
...
The formula for $F^{A}$ defines a disjunctive type constructor \inputencoding{latin9}\lstinline!F!\inputencoding{utf8}
...
of this example, let us choose names \inputencoding{latin9}\lstinline!F1!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!F2!\inputencoding{utf8}, and \inputencoding{latin9}\lstinline!F3!\inputencoding{utf8}.
Each of these case classes needs to have the same type parameter \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}.
So our code will be\inputencoding{latin9}
\begin{lstlisting}
sealed trait F[A]
...
\end{lstlisting}
\inputencoding{utf8}Each of these case classes represents one part of the disjunctive
type: \inputencoding{latin9}\lstinline!F1!\inputencoding{utf8} represents
$\bbnum 1$, \inputencoding{latin9}\lstinline!F2!\inputencoding{utf8}
represents $\text{Int}\times A\times A$, and \inputencoding{latin9}\lstinline!F3!\inputencoding{utf8}
...
\end{lstlisting}
\inputencoding{utf8}The names \inputencoding{latin9}\lstinline!F1!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!F2!\inputencoding{utf8}, \inputencoding{latin9}\lstinline!F3!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!n!\inputencoding{utf8}, \inputencoding{latin9}\lstinline!x1!\inputencoding{utf8},
...
Write the type signature of the function\inputencoding{latin9}
\begin{lstlisting}
def fmap[A, B](f: A => B): Option[A] => Option[B]
\end{lstlisting}
\inputencoding{utf8}in the type notation.
...
\end{lstlisting}
\inputencoding{utf8}The standard disjunctive type \inputencoding{latin9}\lstinline!Option[A]!\inputencoding{utf8}
has two parts, \inputencoding{latin9}\lstinline!None!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!Some[A]!\inputencoding{utf8},
represented in the type notation by $\bbnum 1$ and $A$ respectively.
So, the type notation for \inputencoding{latin9}\lstinline!Option[A]!\inputencoding{utf8}
is $1+A$. Now we can write the type signature of \inputencoding{latin9}\lstinline!fmap!\inputencoding{utf8}
as
\begin{align*}
...
Define a Scala disjunctive type \inputencoding{latin9}\lstinline!MyTU[T,U]!\inputencoding{utf8}
...
Rewrite \inputencoding{latin9}\lstinline!Either[(A, Int), Either[(A, Char), (A, Float)]]!\inputencoding{utf8}
in the type notation.

\subsubsection{Exercise \label{subsec:Exercise-type-notation-3}\ref{subsec:Exercise-type-notation-3}}

Define a Scala type \inputencoding{latin9}\lstinline!OptEither[A, B]!\inputencoding{utf8}
...
type notation into a Scala type signature, we get\inputencoding{latin9}
\begin{lstlisting}
def f[A]: A => A
\end{lstlisting}
\inputencoding{utf8}This type signature can be easily implemented,\inputencoding{latin9}
\begin{lstlisting}
def f[A]: A => A = { x => x }
\end{lstlisting}
\inputencoding{utf8}So, in this example we see how we converted a true formula in logic
into the type of a value \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
...
\hline 
\hline 
{\footnotesize{}$\forall\alpha.\,\alpha\Rightarrow\alpha$} & {\footnotesize{}$\forall A.\,A\Rightarrow A$} & \inputencoding{latin9}\lstinline!def id[A](x:A): A = x!\inputencoding{utf8}\tabularnewline
\hline 
{\footnotesize{}$\forall\alpha.\,\alpha\Rightarrow True$} & {\footnotesize{}$\forall A.\,A\Rightarrow\bbnum 1$} & \inputencoding{latin9}\lstinline!def toUnit[A](x:A): Unit = ()!\inputencoding{utf8}\tabularnewline
\hline 
{\footnotesize{}$\forall(\alpha,\beta).\,\alpha\Rightarrow(\alpha\vee\beta)$} & {\footnotesize{}$\forall(A,B).\,A\Rightarrow A+B$} & \inputencoding{latin9}\lstinline!def toL[A,B](x:A):Either[A,B]=Left(x)!\inputencoding{utf8}\tabularnewline
\hline 
{\footnotesize{}$\forall(\alpha,\beta).\,(\alpha\wedge\beta)\Rightarrow\alpha$} & {\footnotesize{}$\forall(A,B).\,A\times B\Rightarrow A$} & \inputencoding{latin9}\lstinline!def first[A,B](p:(A,B)): A = p._1!\inputencoding{utf8}\tabularnewline
\hline 
{\footnotesize{}$\forall(\alpha,\beta).\,\alpha\Rightarrow(\beta\Rightarrow\alpha)$} & {\footnotesize{}$\forall(A,B).\,A\Rightarrow(B\Rightarrow A)$} & \inputencoding{latin9}\lstinline!def const[A,B](x: A): B=>A = (_ => x)!\inputencoding{utf8}\tabularnewline
\hline 
\end{tabular}
\par\end{center}
...
\hline 
\hline 
{\footnotesize{}$\forall\alpha.\,True\Rightarrow\alpha$} & {\footnotesize{}$\forall A.\,\bbnum 1\Rightarrow A$} & \inputencoding{latin9}\lstinline!def f[A](x: Unit): A = ???!\inputencoding{utf8}\tabularnewline
\hline 
{\footnotesize{}$\forall(\alpha,\beta).\,(\alpha\vee\beta)\Rightarrow\alpha$} & {\footnotesize{}$\forall(A,B).\,A+B\Rightarrow A$} & \inputencoding{latin9}\lstinline!def f[A,B](x: Either[A, B]): A=???!\inputencoding{utf8}\tabularnewline
\hline 
{\footnotesize{}$\forall(\alpha,\beta).\,\alpha\Rightarrow(\alpha\wedge\beta)$} & {\footnotesize{}$\forall(A,B).\,A\Rightarrow A\times B$} & \inputencoding{latin9}\lstinline!def f[A,B](p: A): (A, B) = ???!\inputencoding{utf8}\tabularnewline
\hline 
{\footnotesize{}$\forall(\alpha,\beta).\,(\alpha\Rightarrow\beta)\Rightarrow\alpha$} & {\footnotesize{}$\forall(A,B).\,(A\Rightarrow B)\Rightarrow A$} & \inputencoding{latin9}\lstinline!def f[A,B](x: A => B): A = ???!\inputencoding{utf8}\tabularnewline
\hline 
\end{tabular}
\par\end{center}
...
\end{equation}
which corresponds to the Scala type signature\inputencoding{latin9}
\begin{lstlisting}
def bad[A, B, C](g: A => Either[B, C]): Either[A => B, A => C] = ???
\end{lstlisting}
\inputencoding{utf8}This cannot be implemented as a fully parametric function. To see
...
\inputencoding{latin9}\lstinline!bad!\inputencoding{utf8} must return
...
must be somehow made in the code of \inputencoding{latin9}\lstinline!bad!\inputencoding{utf8}.
...
Scala code:\inputencoding{latin9}
\begin{lstlisting}
...
\end{lstlisting}
\inputencoding{utf8}But this is not the required type signature~(\ref{eq:ch-example-boolean-bad-type}).
...
that we are not allowed to use any specific types such as \inputencoding{latin9}\lstinline!Int!\inputencoding{utf8}
or \inputencoding{latin9}\lstinline!String!\inputencoding{utf8}.
...
values such as \inputencoding{latin9}\lstinline!123!\inputencoding{utf8}
or \inputencoding{latin9}\lstinline!"hello"!\inputencoding{utf8},
or any library functions that work with specific types. The allowed
code constructs are illustrated in this code fragment:\inputencoding{latin9}
\begin{lstlisting}
...
\end{lstlisting}
\inputencoding{utf8}A value of type $X$ can be computed (i.e.~${\cal CH}(X)$ is true)
if and only if we can create a sequence of computed values such as
\inputencoding{latin9}\lstinline!x1!\inputencoding{utf8}, \inputencoding{latin9}\lstinline!x2!\inputencoding{utf8},
...
\end{equation}
corresponds to the code of the function \inputencoding{latin9}
\begin{lstlisting}
def f[A, B]: A => (B => A) = { x => _ => x }
\end{lstlisting}
\inputencoding{utf8}Keeping the CH correspondence in mind, we may say that the function
\inputencoding{latin9}\lstinline!f!\inputencoding{utf8}'s code ``is''
the proof of the proposition~(\ref{eq:ch-proposition-example-2}).
In this sense, the existence of the code \inputencoding{latin9}\lstinline!x => _ => x!\inputencoding{utf8}
...
\paragraph{1) Create a \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
value}

At any place in the code, we may write the expression \inputencoding{latin9}\lstinline!()!\inputencoding{utf8}
of type \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}.
...
that creates a value of the \inputencoding{latin9}\lstinline!Unit!\inputencoding{utf8}
type:
\[
\text{Proof}\left(\Gamma\vdash{\cal CH}(\bbnum 1)\right)=1\quad,
\]
where we denoted by $1$ the value \inputencoding{latin9}\lstinline!()!\inputencoding{utf8}.
...
The code construct \inputencoding{latin9}\lstinline!x:A!\inputencoding{utf8}
...
say, $A\Rightarrow B$, by writing \inputencoding{latin9}\lstinline!(x:A) => expr(x)!\inputencoding{utf8}
as long as an expression \inputencoding{latin9}\lstinline!expr(x)!\inputencoding{utf8}
of type $B$ can be written in the inner scope of the function. The
expression \inputencoding{latin9}\lstinline!expr(x)!\inputencoding{utf8}
...
is an expression \inputencoding{latin9}\lstinline!exprB!\inputencoding{utf8}
...
\inputencoding{latin9}\lstinline!(x:A) => exprB!\inputencoding{utf8}:
this expression has type $A\Rightarrow B$ and requires us to already
have a suitable \inputencoding{latin9}\lstinline!exprB!\inputencoding{utf8}.
...
\inputencoding{latin9}\lstinline!x:A!\inputencoding{utf8} and \inputencoding{latin9}\lstinline!f:A => B!\inputencoding{utf8},
and writes the expression \inputencoding{latin9}\lstinline!f(x)!\inputencoding{utf8}.
...
If we have already computed some values \inputencoding{latin9}\lstinline!x:A!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!y:B!\inputencoding{utf8}, we
may write the expression \inputencoding{latin9}\lstinline!(x, y)!\inputencoding{utf8}
and so compute a value of the tuple type \inputencoding{latin9}\lstinline!(A, B)!\inputencoding{utf8}.
...
as \inputencoding{latin9}\lstinline!(w, x, y, z)!\inputencoding{utf8},
can be expressed via nested pairs, e.g.~as \inputencoding{latin9}\lstinline!(w, (x, (y, z)))!\inputencoding{utf8}.
...
If we already have a value \inputencoding{latin9}\lstinline!t:(A,B)!\inputencoding{utf8}
of a tuple type $A\times B$, we can extract one of the parts of the
tuple and obtain a value of type \inputencoding{latin9}\lstinline!A!\inputencoding{utf8}
or a value of type \inputencoding{latin9}\lstinline!B!\inputencoding{utf8}.
The code is \inputencoding{latin9}\lstinline!t._1!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!t._2!\inputencoding{utf8} respectively,
...
\inputencoding{latin9}\lstinline!_._1!\inputencoding{utf8}.
...
The disjunctive type \inputencoding{latin9}\lstinline!Either[A, B]!\inputencoding{utf8}
...
with three parts can be expressed as \inputencoding{latin9}\lstinline!Either[A, Either[B, C]]!\inputencoding{utf8}.
So it is sufficient to have proof rules for a disjunction of two propositions.

There are two ways of creating a value of the type \inputencoding{latin9}\lstinline!Either[A, B]!\inputencoding{utf8}:
the code expressions are \inputencoding{latin9}\lstinline!Left(x:A)!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!Right(y:B)!\inputencoding{utf8}.
The values \inputencoding{latin9}\lstinline!x:A!\inputencoding{utf8}
or \inputencoding{latin9}\lstinline!y:B!\inputencoding{utf8} must
...
The only way we may use a value of disjunctive type \inputencoding{latin9}\lstinline!Either[A, B]!\inputencoding{utf8}
is by pattern matching on it, which will compute a result of some
other type \inputencoding{latin9}\lstinline!C!\inputencoding{utf8}.
The code looks like this,\inputencoding{latin9}
\begin{lstlisting}
(e: Either[A, B]) match {
...
\end{lstlisting}
\inputencoding{utf8}Here, \inputencoding{latin9}\lstinline!expr1(x)!\inputencoding{utf8}
must be an expression of type \inputencoding{latin9}\lstinline!C!\inputencoding{utf8}
computed using \inputencoding{latin9}\lstinline!x:A!\inputencoding{utf8}
and any previously available arguments (i.e.~the premises $\Gamma$).
Similarly, \inputencoding{latin9}\lstinline!expr2(y)!\inputencoding{utf8}
must be an expression of type \inputencoding{latin9}\lstinline!C!\inputencoding{utf8}
computed using \inputencoding{latin9}\lstinline!y:B!\inputencoding{utf8}
and previous arguments. It is clear that \inputencoding{latin9}\lstinline!expr1(x)!\inputencoding{utf8}
represents a proof of a sequent with an additional premise of type
\inputencoding{latin9}\lstinline!A!\inputencoding{utf8}, i.e.~$\Gamma,\alpha\vdash\gamma$,
where we denoted $\gamma\triangleq{\cal CH}(C)$. Similarly, \inputencoding{latin9}\lstinline!expr2(y)!\inputencoding{utf8}
is a proof of the sequent $\Gamma,\beta\vdash\gamma$. So, the proof
rule corresponding to the \inputencoding{latin9}\lstinline!match!\inputencoding{utf8}
expression is
\[
...
The task is to implement a fully parametric function with type signature\inputencoding{latin9}
\begin{lstlisting}
def f[A, B]: ((A => A) => B) => B = ???
\end{lstlisting}
\inputencoding{utf8}
...
the fully parametric function \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
...
LJT algorithm. The library provides the method \inputencoding{latin9}\lstinline!implement!\inputencoding{utf8}
used like this:\inputencoding{latin9}
\begin{lstlisting}
...
a => a (b => b (c => a (d => c)))
\end{lstlisting}
\inputencoding{utf8}The automatically derived code for the function \inputencoding{latin9}\lstinline!f!\inputencoding{utf8}
...
cannot be implemented as a fully parametric function:\inputencoding{latin9}
\begin{lstlisting}
...
Compilation Failed
\end{lstlisting}
\inputencoding{utf8}The logical formula corresponding to this type signature is 
\begin{equation}
...
type signature,\inputencoding{latin9}
\begin{lstlisting}
def g[A, B]: ((A => B) => A) => A = ???
\end{lstlisting}
\inputencoding{utf8}we will be unable to write code for \inputencoding{latin9}\lstinline!g!\inputencoding{utf8}
...
functions with type signatures\inputencoding{latin9}
\begin{lstlisting}
def f1[A, B, C]: ((Either[A, B], C))    => Either[(A, C), (B, C)] = ???
def f2[A, B, C]: Either[(A, C), (B, C)] => (Either[A, B], C) = ???
\end{lstlisting}
\inputencoding{utf8}In the type notation, these two type signatures are written as
\begin{align*}
...
\inputencoding{latin9}\lstinline!f1!\inputencoding{utf8} and \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8}.
...
So, instead of deriving the implementations of \inputencoding{latin9}\lstinline!f1!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8} from
the CH correspondence, we will write the Scala code directly.

To implement \inputencoding{latin9}\lstinline!f1!\inputencoding{utf8},
we need to do pattern matching on the argument:\inputencoding{latin9}
\begin{lstlisting}
def f1[A, B, C]: ((Either[A, B], C)) => Either[(A, C), (B, C)] = {
...
\end{lstlisting}
\inputencoding{utf8}In both cases, we have only one possible expression of the correct
type.

Similarly, the implementation of \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8}
leaves us no choices:\inputencoding{latin9}
\begin{lstlisting}
def f2[A, B, C]: Either[(A, C), (B, C)] => (Either[A, B], C) = {
  case Left((a, c))   => (Left(a), c)  // No other choice here.
  case Right((b, c))  => (Right(b), c) // No other choice here.
...
and \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8} never
...
a requirement that an arbitrary value \inputencoding{latin9}\lstinline!x:(Either[A, B], C)!\inputencoding{utf8}
is mapped by \inputencoding{latin9}\lstinline!f1!\inputencoding{utf8}
to some value \inputencoding{latin9}\lstinline!y:Either[(A, C), (B, C)]!\inputencoding{utf8}
and then mapped by \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8}
back to \emph{the same} value \inputencoding{latin9}\lstinline!x!\inputencoding{utf8}.
Similarly, any value \inputencoding{latin9}\lstinline!y:Either[(A, C), (B, C)]!\inputencoding{utf8}
should be transformed by \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8}
and then by \inputencoding{latin9}\lstinline!f1!\inputencoding{utf8}
back to the \emph{same value} \inputencoding{latin9}\lstinline!y!\inputencoding{utf8}. 
...
\inputencoding{latin9}\lstinline!f1 andThen f2!\inputencoding{utf8}.
)
...
a tuple \inputencoding{latin9}\lstinline!(Left(a), c)!\inputencoding{utf8}
or a tuple \inputencoding{latin9}\lstinline!(Right(b), c)!\inputencoding{utf8},
for some values \inputencoding{latin9}\lstinline!a:A!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!b:B!\inputencoding{utf8}, and \inputencoding{latin9}\lstinline!c:C!\inputencoding{utf8}.
The Scala code of \inputencoding{latin9}\lstinline!f1!\inputencoding{utf8}
maps these tuples to \inputencoding{latin9}\lstinline!Left((a, c))!\inputencoding{utf8}
and to \inputencoding{latin9}\lstinline!Right((b, c))!\inputencoding{utf8}
respectively; we can see this directly from the code of \inputencoding{latin9}\lstinline!f1!\inputencoding{utf8}.
We then apply $f_{2}$ to those values, which maps them back to a
tuple \inputencoding{latin9}\lstinline!(Left(a), c)!\inputencoding{utf8}
or a tuple \inputencoding{latin9}\lstinline!(Right(b), c)!\inputencoding{utf8}
respectively, according to the code of \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8}.
...
which must be one of the two disjoint cases, \inputencoding{latin9}\lstinline!Left((a, c))!\inputencoding{utf8}
or \inputencoding{latin9}\lstinline!Right((b, c))!\inputencoding{utf8}.
The code of \inputencoding{latin9}\lstinline!f2!\inputencoding{utf8}
maps these two cases into tuples \inputencoding{latin9}\lstinline!(Left(a), c)!\inputencoding{utf8}
or a tuple \inputencoding{latin9}\lstinline!(Right(b), c)!\inputencoding{utf8}
respectively. Then we apply \inputencoding{latin9}\lstinline!f1!\inputencoding{utf8},
which will map these tuples back to \inputencoding{latin9}\lstinline!Left((a, c))!\inputencoding{utf8}
or \inputencoding{latin9}\lstinline!Right((b, c))!\inputencoding{utf8}
...
or in Scala syntax \inputencoding{latin9}\lstinline!((A, B), C)!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!(A, (B, C))!\inputencoding{utf8}.
We can define functions mapping between these types without information
loss:\inputencoding{latin9}
\begin{lstlisting}
def f3[A, B, C]: (((A, B), C)) => (A, (B, C)) = { case ((a, b), c) => (a, (b, c)) }
def f4[A, B, C]: (A, (B, C)) => (((A, B), C)) = { case (a, (b, c)) => ((a, b), c) }
\end{lstlisting}
\inputencoding{utf8}By applying these functions to arbitrary values of types \inputencoding{latin9}\lstinline!((A, B), C)!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!(A, (B, C))!\inputencoding{utf8},
it is easy to see that the functions \inputencoding{latin9}\lstinline!f3!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!f4!\inputencoding{utf8} are
...
The type denoted by $\bbnum 1+A$ is the same as \inputencoding{latin9}\lstinline!Option[A]!\inputencoding{utf8}
in Scala.
...
is called además hindley-milner algorithm and I'm giving the links
