...
\hline 
{\scriptsize{}contramonad} & {\scriptsize{}$B\Rightarrow F^{A}$} & {\scriptsize{}$\text{contraflm}:\left(B\Rightarrow F^{A}\right)\Rightarrow F^{A}\Rightarrow F^{B}$}\tabularnewline
\hline 
\end{tabular}
\par\end{center}
