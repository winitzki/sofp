...
\item Associativity law: {\footnotesize{}$g\odot\left(h\odot k\right)=\text{fmap2}\left(\circ\right)\left(g\times\text{fmap2}\left(\circ\right)\left(h\times k\right)\right)$t)\left(h\times k\right)\right)$}
...
Have \texttt{\textcolor{blue}{\footnotesize{}pure}} $:A\Rightarrow P^{A}$
\end{itemize}
\end{itemize}
...
\item Some classes (e.g.\ contra-applicative) are not covered by this scheme
