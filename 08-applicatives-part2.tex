...
\item The law is {\footnotesize{}$g\odot(x\Rightarrow x\circ f)^{\uparrow}h=(x\Rightarrow x\circ f)^{\uparrow}\left(g\odot h\right)${\uparrow}\left(g\odot h\right)$}
...
But have \texttt{\textcolor{blue}{\footnotesize{}pure}} $:A\Rightarrow P^{A}$
\end{itemize}
\end{itemize}
