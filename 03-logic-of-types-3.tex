...
\item Short notation: 
\[
\text{UserAction}=\text{String}\times\text{String}+\text{String}+\text{Long}
\]
\end{itemize}
...
into an equivalent type of the form {\footnotesize{}$A\times(...)$
}and{\footnotesize{} }write{\footnotesize{} }the{\footnotesize{} }equivalence
tests{\footnotesize{} ~}{\footnotesize \par}
