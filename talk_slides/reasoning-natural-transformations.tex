...
The vertical composition of $\alpha:F^{A}\rightarrow G^{A}$ and $\beta:G^{A}\rightarrow H^{A}$
is the ordinary function composition $\left(\alpha\bef\beta\right):F^{A}\rightarrow H^{A}$

The horizontal composition of $\alpha:F^{A}\rightarrow G^{A}$ and
$\alpha^{\prime}:F^{\prime A}\rightarrow G^{\prime A}$ is $\left(\alpha\star\alpha^{\prime}\right):F^{F^{\prime A}}\rightarrow G^{G^{\prime A}}$
\begin{itemize}
