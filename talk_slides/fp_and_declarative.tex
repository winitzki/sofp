...
\title[FP and declarative programming]{Functional programming vs.~declarative programming}
...
\end{itemize}
Declarative programming is domain-specific (DSL)
\begin{itemize}
\item Different domains have evolved different languages
\end{itemize}
Implementing DSLs is a ``killer app'' for functional programming
\begin{itemize}
\item FP is declarative for recursive manipulation of labeled trees
\end{itemize}
\end{frame}
...
\textcolor{blue}{//~But~the~code~in~another~module~does~this:}
