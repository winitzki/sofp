...
\begin{itemize}
\item Beyond Yoneda: a first example
\item The Church encoding of recursive types
...
andThen f)}} for all \texttt{\textcolor{blue}{\small{}f:~A => B}},
\texttt{\textcolor{blue}{\small{}k:~R => A}}{\small\par}
...
= K}} where \texttt{\textcolor{blue}{\small{}K}} is another type parameter
...
= K}} then \texttt{\textcolor{blue}{\small{}fmap\_F(f) = identity}}{\small\par}
...
\texttt{\textcolor{blue}{\small{}cmap\_F{[}A, B{]}:~(A => B) => F{[}B{]}
=> F{[}A{]}}}{\small\par}
\item Use structural induction on the type of \texttt{\textcolor{blue}{\small{}F{[}\_{]}}}:
\begin{enumerate}
\item If \texttt{\textcolor{blue}{\small{}F{[}A{]} = Unit}} or \texttt{\textcolor{blue}{\small{}F{[}A{]}
= K}} then \texttt{\textcolor{blue}{\small{}cmap\_F(f) = identity}}{\small\par}
...
Each construction decomposes the code of \texttt{\textcolor{blue}{\small{}t{[}A{]}(z)}}
...
the inductive assumption says:\\
 \texttt{\textcolor{blue}{\small{}(g(z1)(h1), g(z2)(h2)) in rmap\_Q(r)}}{\small\par}
...
in rmap\_Q(r)}} where \texttt{\textcolor{blue}{\small{}Q{[}A{]} =
(U{[}A{]}, V{[}A{]})}}{\small\par}
\begin{itemize}
...
\begin{itemize}
\item The case \texttt{\textcolor{blue}{\small{}t{[}A{]}(z) = Right{[}G{[}A{]},
...
= f(z)(t(z))}} where \texttt{\textcolor{blue}{\small{}f(z):~Q{[}A{]}
=> Q{[}A{]}}}{\small\par}
...
== Right(x)}}, \texttt{\textcolor{blue}{\small{}q(l) == Right(y)}}
...
$\cong$ S{[}T{]}}} with a \emph{contravariant} \texttt{\textcolor{blue}{\small{}S{[}\_{]}}}{\small\par}
\end{itemize}
...
\begin{frame}{Advanced applications. III. A third-order function}
\begin{itemize}
\item Use the \emph{naturality} \emph{law} for functions \texttt{\textcolor{blue}{\small{}h{[}A{]}:~G{[}A{]}
=> A}} where \texttt{\textcolor{blue}{\small{}G{[}A{]}}} is defined
by \texttt{\textcolor{blue}{\small{}G{[}A{]} = (A => Option{[}K{]})
=> A}} and is covariant in \texttt{\textcolor{blue}{\small{}A}}:

for any \texttt{\textcolor{blue}{\small{}f:~X => Y}} and \texttt{\textcolor{blue}{\small{}gx:~G{[}X{]}}}:~
\texttt{\textcolor{blue}{\small{}h{[}Y{]}(gx.map(f)) == f(h{[}X{]}(gx))}}{\small\par}
\item Here \texttt{\textcolor{blue}{\small{}gx.map(f) == (k:~Y => Option{[}K{]})
=> f(gx(f andThen k))}}{\small\par}
\item Naturality law: \texttt{\textcolor{blue}{\small{}h{[}Y{]}(k => f(gx(f
andThen k))) == f(h{[}X{]}(gx))}}{\small\par}
...
\texttt{\textcolor{blue}{\small{}gx:~G{[}Option{[}K{]} = (t:~Option{[}K{]}
=> Option{[}K{]}) => t(None)}}{\small\par}
\item Then LHS: \texttt{\textcolor{blue}{\small{}f(h{[}X{]}(gx)) == p(\_
=> h{[}Option{[}K{]}{]}(t => t(None)))}}{\small\par}
\item The LHS is exactly what we need (with arbitrary \texttt{\textcolor{blue}{\small{}p:~G{[}A{]}}})
\item But the RHS is: \texttt{\textcolor{blue}{\small{}h{[}Y{]}(k => f(gx(f
andThen k))) ==}}{\small\par}
...
prove that, for any \texttt{\textcolor{blue}{\small{}p:~G{[}A{]}}},
we have:
