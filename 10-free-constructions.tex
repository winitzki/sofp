...
$\Rightarrow$ N{[}A{]}}} 
\begin{itemize}
\item For example, transform into another monadic DSL to optimize, etc.
\end{itemize}
\item Since \texttt{\textcolor{blue}{\footnotesize{}DSL{[}F,A{]}}} has a
monad API, we can use monad transformers on it
\item Can combine two or more DSLs in a disjunction: \texttt{\textcolor{blue}{\footnotesize{}DSL{[}F
\textbackslash / G, A{]}}} 
\end{itemize}
\end{frame}
