...
\textcolor{blue}{\footnotesize{}~def~run{[}X{]}(cp:~P~\textcolor{blue}{\footnotesize{}~def~run{[}X{]}(cp:~P~$\Rightarrow$~X)(cq:~Q~$\Rightarrow$~X):~X~=~cp(p)~}{\footnotesize\par}
...
\end{lyxcode}
\begin{itemize}
\item {\footnotesize{}\vspace{-0.15cm}}The functions \texttt{\textcolor{blue}{\footnotesize{}a2c}}
and \texttt{\textcolor{blue}{\footnotesize{}c2a}} are inverses of
each other
\begin{itemize}
