...
\begin{itemize}
\item Free monad $\text{FreeM}^{M^{\bullet},\bullet}$ over a monad $M^{\bullet}$eeM}^{M^{\bullet},\bullet}$ over a monad $M^{\bullet}$
...
implementation
\item Use \texttt{\textcolor{blue}{\footnotesize{}Future}} but convert \texttt{\textcolor{blue}{\footnotesize{}zip}}
