...
\begin{frame}{Generalize: Universal property and initiality}
\begin{itemize}
\item Generaize from free monad and free monoid/ semigroup to free typeclass
C
\item Which typeclass can or cannot be made free
\end{itemize}
\end{frame}

\begin{frame}{Refactor for multiple targets: Continuation encoding}
