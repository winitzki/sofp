...
that $Z$ ``exists''
\end{itemize}
\item Type notation for this: $Q^{A}\equiv\exists Z.A\times Z$pe notation for this: $Q^{A}\equiv\exists Z.A\times Z$
\begin{itemize}
...
\end{itemize}
What typeclasses can't be encoded like this (or have no ``free''
instances)?
\begin{itemize}
...
\begin{itemize}
\item Laws hold after ``running''
\item Free constructions are ``universal'' DSL programs
\end{itemize}
\end{frame}
