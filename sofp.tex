...
The PDF file \inputencoding{latin9}\lstinline!sofp.pdf!\inputencoding{utf8}
contains the full source code of the book as an ``attachment''.
...
from sources, run \inputencoding{latin9}\lstinline!`bash make_sofp_pdf.sh`!\inputencoding{utf8}.}
