...
\begin{itemize}
\item and cite the same paper by Dyckhoff {[}1992{]}
...
\begin{itemize}
\item Apply all rules that fit the sequent, and repeat
\end{itemize}
...
be equivalent 
\begin{itemize}
\item Logic identities give only the ``equal implementability''{itemize}
\end{itemize}
