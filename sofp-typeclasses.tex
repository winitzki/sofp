...
This is similar to the concept of \emph{partial functions} – applied
to types
...
}\textcolor{gray}{\footnotesize{}// ``sealed'' GADT – user code
can't add cases}{\footnotesize\par}
...
trying to do so will fail \emph{at compile time} \ – TE values won't
type-check
...
PTTF – its type argument is \texttt{\textcolor{blue}{\footnotesize{}F{[}\_{]}}}{\footnotesize\par}
