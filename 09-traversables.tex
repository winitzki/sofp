...
\item To derive the laws, use the ``m To derive the laws, use the ``lifting'' intuition for \texttt{\textcolor{blue}{\footnotesize{}traverse}},{\footnotesize{}
\[
...
A bifunctor $S^{A,B}$ is bitraversable if \texttt{\textcolor{blue}{\footnotesize{}biseq}}
exists such that
\[
