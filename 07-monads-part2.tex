...
\begin{itemize}
\item Within a generator, \texttt{\textcolor{blue}{\footnotesize{}\{... y
$\leftarrow$ p\} yield y}} is the same as \texttt{\textcolor{blue}{\footnotesize{}p}}:
\end{itemize}
\texttt{\textcolor{blue}{\footnotesize{}}}%
\begin{minipage}[c][1\totalheight][t]{0.49\columnwidth}%
\begin{lyxcode}
...
$\text{flm}\,f^{A\Rightarrow S^{B}}\equiv\text{id}^{S^{A}\Rightarrow S^{A}}\diamond f${A}\Rightarrow S^{A}}\diamond f$}{\small \par}
