...
when $p(x)$ is a polynomial of the form 
\[
p(x)=x^{n_{1}}+x^{n_{2}}+...+x^{n_{k}}
\]
for some positive integer $n_{1}$, ..., $n_{k}$. Any $F^{A}$ of
this form may be obtained out of the identity monad via constructions
3 and 5.
