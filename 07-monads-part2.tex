...
associativity:{\footnotesize{} $\text{ftn}_{\uparrow}\circ\text{ftn}=\text{ftn}\circ\text{ftn}$} 
\end{enumerate}
\begin{itemize}
...
needs more work
\begin{itemize}
\item The ``accumulated context'' is completely different for these monads
\end{itemize}
\end{itemize}
