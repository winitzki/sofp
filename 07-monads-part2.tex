...
\item Naturality for \texttt{\textcolor{blue}{\footnotesize{}pure}}: or{blue}{\footnotesize{}pure}}: $\text{pure}\circ\text{fmap}\,f=\text{pure}\diamond\left(f\circ\text{pure}\right)=f\circ\text{pure}$
