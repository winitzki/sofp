...
have an operation of type $F^{A}\times F^{A}\rightarrow F^{A}$).
...
and~(\ref{eq:foldFn-second-special-law}). We will show below that
these laws are a consequence of parametricity. In other words, \lstinline!foldFn(p)!
