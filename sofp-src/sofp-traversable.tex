...
\end{align*}
The two sides are equal. So, every contrafunctor is traversable.
...
\subsection{Recursion schemes for nested recursive types}

\paragraph{Perfect-shaped binary tree}
