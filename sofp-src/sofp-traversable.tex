...
\end{lstlisting}
Here \lstinline!F[_]! is an arbitrary applicative functor. In the
short type notation, this type signature is:
\[
...
In all examples above, we merge all $F$-effects together by collecting
