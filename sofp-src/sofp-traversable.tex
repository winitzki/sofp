...
One year later, R.~Bird\index{Richard Bird} et al.~showed that
...
\lstinline!traverse! by using techniques motivated by dependent type
theory.\footnote{\label{fn:uitbaf}See \texttt{\href{https://www.cs.ox.ac.uk/jeremy.gibbons/publications/uitbaf.pdf}{https://www.cs.ox.ac.uk/jeremy.gibbons/publications/uitbaf.pdf}}}
...
This is proved by Bird et al.\footnote{See Footnote~\ref{fn:uitbaf} on page~\pageref{fn:uitbaf}.}~as
