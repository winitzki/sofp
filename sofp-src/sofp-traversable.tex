...
leaves). This data structure supports unfolding with any function
$f:Z\rightarrow S^{A,Z}$ because the recursive evaluation of $f$
at the branches is always delayed. So, we can use \lstinline!unfold!
to generate a value of type $L^{A}$ whose tree structure has the
...
\subsection{Recursion schemes for regular-shaped trees}
