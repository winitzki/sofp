...
is itself a monoid that we will here denote by $\text{MF}^{B}\triangleq B\rightarrow B$.
...
\begin{align*}
 & \text{foldFn}^{\prime}(p^{:L^{B\rightarrow B}})=\text{reduceE}\,(p)=\text{foldFn}\,(p\triangleright\text{inMF}^{\uparrow L})(e_{\text{MF}})\quad.
\end{align*}
Here the function \lstinline!inMF! is used with the type signature
corresponding to the monoid $M\triangleq A\rightarrow A$:
\begin{align*}
 ...
 & \text{inMF}\triangleq g^{:B\rightarrow B}\rightarrow h^{:B\rightarrow B}\rightarrow h\bef g\quad,\\
 & e_{\text{MF}}\triangleq\text{id}^{:\left(B\rightarrow B\right)\rightarrow B\rightarrow B}\quad.
\end{align*}

We find that $\text{foldFn}^{\prime}(p)=\text{foldFn}\,(p)$ if we
assume that the following law holds:
\begin{equation}
\text{foldFn}^{B}(p^{:L^{B\rightarrow B}})=\text{foldFn}^{B\rightarrow B}(p\triangleright\text{inMF}^{\uparrow L})(e_{\text{MF}})\quad.\label{eq:foldFn-transformation-law}
\end{equation}
This special law is a consequence of parametricity (see Example~\ref{subsec:relational-property-for-foldFn}).
...
\begin{align*}
 & \text{reduceE}^{\prime}(p^{:L^{M}})=\text{foldFn}\,(p\triangleright\text{inMF}^{\uparrow L})(e_{M})=\text{reduceE}\,(p\triangleright\text{inMF}^{\uparrow L})(e_{M})\\
...
\begin{align*}
 & \text{foldFn}\,(p\triangleright\text{inMF}^{\uparrow L})(e_{\text{MF}})=\text{reduceE}\,(p\triangleright\text{inMF}^{\uparrow L})(e_{\text{MF}})\\
