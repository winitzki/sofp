...
We assume that \lstinline!L[_]! is a traversable functor whose \lstinline!trav!
...
monad whose output value will be also of type \lstinline!Z! (type
constructor \lstinline!State[Z, Z]!). The implementation of \lstinline!scanLeft!
simply calls \lstinline!traverse! with a function \lstinline!f!
that creates a suitable value of the \lstinline!State! monad:
\begin{lstlisting}
