...
theory is complicated but has limited practical use. Because all polynomial
functors are traversable (and no other functors are), it is not as
important to be able to characterize \lstinline!traverse! solely
...
functor and any traversal order. 
