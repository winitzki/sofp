...
The last two statements show that a type constructor built up via
...
\text{composition law of }L:\quad & =\text{fmap}_{L}(g\circ f)\\
\text{use }g\circ f=\text{id}:\quad & =\text{fmap}_{L}(\text{id})\\
