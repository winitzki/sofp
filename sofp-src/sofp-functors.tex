...
Here is an artificial example\footnote{The following example was given in a comment by \index{Pawel{} Szulc@Pawe\l{} Szulc}Pawe\l{}
Szulc at \texttt{\href{https://gist.github.com/tpolecat/7401433}{https://gist.github.com/tpolecat/7401433}}} of a type whose \lstinline!.equals! method violates the required
properties:
\begin{lstlisting}
...
What type expressions will give us a functor? Functional programming
...
We can check all the available type constructions for obeying the
functor laws. The results are summarized in Table~\ref{tab:f-Functor-constructions}. 
...
For abstract syntax trees, the functors $P^{\bullet}$ and $Q^{\bullet}$
...
Profunctors are not often used in practical coding. We will occasionally
see profunctors in later chapters.
