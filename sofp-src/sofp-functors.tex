...
of a type $Q$ if (1) there exists a designated\index{subtyping!type conversion function}
...
A simple example of subtyping is with disjunctive types. Consider
...
\end{lstlisting}
In the type notation, this definition looks like this:
\[
...
composed with an identity function that reassigns the types.
