...
as contravariant type constructors.\footnote{The name ``\textbf{contrafunctor}''\index{contrafunctor} is used
...
and similarly for surjective functions $f$. Let us conclude this
chapter by deriving this property.
