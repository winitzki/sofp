...
parametric ``data wrappers'' turns out to be a powerful design pattern
of functional programming. To fully realize its benefits, we will
formalize the concept of ``data wrapping'' through a set of mathematical
...
method, rather than defining \lstinline!map! as a function, which
