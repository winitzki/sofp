...
languages support the five main type constructions shown in Table~\ref{tab:ch-correspondence-type-notation-CH-propositions}
...
\hline 
{\footnotesize{}tuple} & {\footnotesize{}$L^{A}\triangleq P^{A}\times Q^{A}$} & {\footnotesize{}the functor product; $P$ and $Q$ must be functors}\tabularnewline
\hline 
