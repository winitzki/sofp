...
(pronounced \textsf{``}lifted to $L$\textsf{''}). For any functtion $f$ of type
...
is called a \textbf{profunctor}\index{profunctor|textit}. The type
constructor $\tilde{P}^{Z,A}$ is also called a \textbf{profunctor}.
