...
mumbo-jumbo, claptrap, gibberish, abracadabra, gobbledygook
...
The \textsf{``}liftings\textsf{''} show the types of category's morphisms
\begin{center}
\begin{tabular}{|c|c|c|}
\hline 
...
\begin{enumerate}
\item Show that pure will be automatically a natural transformation when
it is defined using wu as shown in the slides.
