...
equal shape without adding any new branchings. For instance, the result
of evaluating {\tiny{}}zip({\tiny{} \Tree[ [ [ $a$ ] [ $b$ ] ]  [ $c$ ] ] }, {\tiny{} \Tree[ [ [ $d$ ] [ $e$ ] ]  [ $f$ ] ] })
should be the tree {\tiny{}}{\tiny{} \Tree[ [ [ $a\times d$ ] [ $b\times e$ ] ]  [ $c\times f$ ] ] }.
But if a subtree of \lstinline!ta! is a leaf value \lstinline!Leaf(x)!
while the corresponding subtree of \lstinline!tb! is a \lstinline!Branch!,
the value \lstinline!x! must be replicated to match the subtree of
\lstinline!tb!. So, the result of evaluating {\tiny{}}zip({\tiny{} \Tree[ [ $a$ ] [ $b$ ] ] }, {\tiny{} \Tree[ [ [ $c$ ] [ [ $d$ ] [ $e$ ] ] ]  [ $f$ ] ] })
should be {\tiny{}}{\tiny{} \Tree[ [ [ $a\times c$ ] [ [ $a\times d$ ] [ $a\times e$ ] ] ]  [ $b\times f$ ] ] }.
...
scala> zip(tb, tc)
res1: BTree[(String, String)] = Branch(Branch(Leaf(("a", "c")), Branch(Leaf(("a", "d")), Leaf(("a", "e")))), Leaf(("b", "f"))) 
\end{lstlisting}
$\square$
...
contravariant yet support a suitable \lstinline!zip! method. Implementing
the \lstinline!zip! method will then enable automatic typeclass derivation
for product types (such as case classes).

\subsection{Programs that accumulate errors during computations}
...
\subsection{Implementing the functions \texttt{map2}, \texttt{map3}, etc.}
...
Consider 1, 2, 3, ... commutative and independent \textsf{``}effects\textsf{''}

\texttt{\textcolor{blue}{\footnotesize{}\medskip{}
}}%
...
%
\end{minipage}\texttt{\textcolor{blue}{\footnotesize{}\hfill{}\medskip{}
}}Note that the map2 function defined via flatMap will have the right
type signature and will work. But sometimes we need a different implementation,
not equivalent to an implementation via flatMap.\texttt{\textcolor{blue}{\footnotesize{}\medskip{}
}}{\footnotesize\par}
...
However, we may need to define the \lstinline!map2! method in a different
way, because defining \lstinline!map2! via \lstinline!flatMap! would
not give us the required functionality.{*}{*}{*}
