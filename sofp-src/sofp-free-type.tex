...
\section{Motivation for the free monad: refining a DSL in five steps}
...
Let us recall our first example (a DSL for complex numbers) and rewrite
it in a similar way:
\begin{lstlisting}
...
operations are implemented in the same way. The differences are in
the code for file-specific and complex number-specific operations.
