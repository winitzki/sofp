...
for aggregating tree-like data (Section~\subsecref{Aggregating-tree-like-data-bfs}).
...
can be simplifed to just \inputencoding{latin9}\lstinline!NEL[T]!\inputencoding{utf8}
since \inputencoding{latin9}\lstinline!Wrap!\inputencoding{utf8}
no longer serves any function. So, we reuse the non-empty list type
\inputencoding{latin9}\lstinline!NEL!\inputencoding{utf8} and its
\inputencoding{latin9}\lstinline!concat!\inputencoding{utf8} function
...
does not satisfy any of the monoid laws. This is not a problem in
practice, since laws will hold after running an \inputencoding{latin9}\lstinline!FMR!\inputencoding{utf8}-program
...
The raw tree encoding may be transformed into a shorter, \textsf{``}reduced\textsf{''}
...
why the functor laws do not hold for \inputencoding{latin9}\lstinline!FFR[F, A]!\inputencoding{utf8}.
...
the free monad encoding \inputencoding{latin9}\lstinline!Free2!\inputencoding{utf8}
(see Section~\ref{subsec:Motivation-free-monad-different-encodings})
can be seen as the encoding \inputencoding{latin9}\lstinline!Free1!\inputencoding{utf8}
applied to the free functor \inputencoding{latin9}\lstinline!FF[F, A]!\inputencoding{utf8}.
It follows that the free monad encodings \inputencoding{latin9}\lstinline!Free1!\inputencoding{utf8}
