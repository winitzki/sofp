...
The effect constructor for the \lstinline!PrgFile! DSL contains the
operations \lstinline!Path! and \lstinline!Read!. We define:
\begin{lstlisting}
...
\end{lstlisting}
Now we refactor \lstinline!PrgFile! by wrapping all file operations
in a subtype called \lstinline!Ops!:
\begin{lstlisting}
sealed 
\end{lstlisting}
