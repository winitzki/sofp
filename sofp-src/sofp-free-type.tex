...
$A\rightarrow A$ in the last line, we set $q$\textsf{'}s type parameter $X$
...
\begin{align*}
{\color{greenunder}\text{expect to equal }q^{C}(r\bef f):}\quad & q^{B}(r)\bef f^{\uparrow F}=p\triangleright r^{\uparrow F}\bef f^{\uparrow F}=p\triangleright(r\bef f)^{\uparrow F}=q^{C}(r\bef f)\quad.
\end{align*}
...
The next statement shows that one can always change the underlying
functor $F$ while preserving all the free monad operations.
...
The free monad constructor is natural in the functor $F$: for any
functor $G$ and any natural transformation $\phi:F^{A}\rightarrow G^{A}$,
the corresponding transformation $\psi:\text{Free}^{F,A}\rightarrow\text{Free}^{G,A}$
defined by
\[
\psi:\text{Free}^{F,A}\rightarrow\text{Free}^{G,A}\quad,\quad\quad\psi\triangleq\,\begin{array}{|c||cc|}
 & A & G^{\text{Free}^{G,A}}\\
...
Denote $P\triangleq\text{Free}^{F}$ and $Q\triangleq\text{Free}^{G}$.
...
\begin{align*}
{\color{greenunder}\text{left-hand side}:}\quad & \text{ftn}_{T}\bef\psi=\,\begin{array}{|c||cc|}
 & A & F^{T^{A}}\\
\hline A & \text{id} & \bbnum 0\\
...
\end{array}\,\bef\,\begin{array}{|c||cc|}
 & A & G^{T^{\prime A}}\\
\hline A & \text{id} & \bbnum 0\\
F^{T^{A}} & \bbnum 0 & \overline{\psi}^{\uparrow F}\bef\phi
\end{array}\\
 & \quad=\,\begin{array}{|c||cc|}
 & A & G^{T^{\prime A}}\\
\hline A & \text{id} & \bbnum 0\\
F^{T^{A}} & \bbnum 0 & \overline{\psi}^{\uparrow F}\bef\phi\\
F^{T^{T^{A}}} & \bbnum 0 & \overline{\text{ftn}}_{T}^{\uparrow F}\bef\overline{\psi}^{\uparrow F}\bef\phi
\end{array}\quad,\\
{\color{greenunder}\text{right-hand side}:}\quad & \psi^{\uparrow T}\bef\psi\bef\text{ftn}_{T^{\prime}}=\,\begin{array}{|c||ccc|}
 & A & G^{T^{\prime A}} & F^{T^{T^{\prime A}}}\\
\hline A & \text{id} & \bbnum 0 & \bbnum 0\\
F^{T^{A}} & \bbnum 0 & \psi^{\uparrow F}\bef\phi & \bbnum 0\\
F^{T^{T^{A}}} & \bbnum 0 & \bbnum 0 & \overline{\psi}^{\uparrow T\uparrow F}
\end{array}\,\bef\,\begin{array}{|c||ccc|}
 & A & G^{T^{\prime A}} & G^{T^{\prime T^{\prime A}}}\\
\hline A & \text{id} & \bbnum 0 & \bbnum 0\\
G^{T^{\prime A}} & \bbnum 0 & \text{id} & \bbnum 0\\
F^{T^{T^{\prime A}}} & \bbnum 0 & \bbnum 0 & \overline{\psi}^{\uparrow F}\bef\phi
\end{array}\,\bef\text{ftn}_{T}\\
 & =\,\begin{array}{|c||ccc|}
 & A & G^{T^{\prime A}} & G^{T^{\prime T^{\prime A}}}\\
\hline A & \text{id} & \bbnum 0 & \bbnum 0\\
F^{T^{A}} & \bbnum 0 & \psi^{\uparrow F}\bef\phi & \bbnum 0\\
F^{T^{T^{A}}} & \bbnum 0 & \bbnum 0 & \overline{\psi}^{\uparrow T\uparrow F}\bef\overline{\psi}^{\uparrow F}\bef\phi
\end{array}\,\bef\,\begin{array}{|c||cc|}
 & A & G^{T^{\prime A}}\\
\hline A & \text{id} & \bbnum 0\\
G^{T^{\prime A}} & \bbnum 0 & \text{id}\\
G^{T^{\prime T^{\prime A}}} & \bbnum 0 & \overline{\text{ftn}}_{T^{\prime}}^{\uparrow G}
\end{array}\\
 & =\,\,\begin{array}{|c||cc|}
 & A & G^{T^{\prime A}}\\
\hline A & \text{id} & \bbnum 0\\
F^{T^{A}} & \bbnum 0 & \psi^{\uparrow F}\bef\phi\\
F^{T^{T^{A}}} & \bbnum 0 & \overline{\psi}^{\uparrow T\uparrow F}\bef\overline{\psi}^{\uparrow F}\bef\phi\bef\overline{\text{ftn}}_{T^{\prime}}^{\uparrow G}
\end{array}\quad.
\end{align*}
The remaining difference is between the last rows of the matrices:
\[
\overline{\text{ftn}}_{T}^{\uparrow F}\bef\overline{\psi}^{\uparrow F}\bef\phi\overset{?}{=}\overline{\psi}^{\uparrow T\uparrow F}\bef\overline{\psi}^{\uparrow F}\bef\phi\bef\overline{\text{ftn}}_{T^{\prime}}^{\uparrow G}\quad.
\]
By the inductive assumption, the law already holds for recursive calls
of $\overline{\psi}$:
\[
\text{ftn}_{T}\bef\overline{\psi}=\overline{\psi}^{\uparrow T}\bef\overline{\psi}\bef\text{ftn}_{T^{\prime}}\quad.
\]
So, it remains to show that
\[
(\overline{\psi}^{\uparrow T}\bef\overline{\psi}\bef\text{ftn}_{T^{\prime}}\big)^{\uparrow F}\bef\phi\overset{?}{=}\overline{\psi}^{\uparrow T\uparrow F}\bef\overline{\psi}^{\uparrow F}\bef\phi\bef\overline{\text{ftn}}_{T^{\prime}}^{\uparrow G}\quad.
\]
