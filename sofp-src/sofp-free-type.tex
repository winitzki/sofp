...
showing that the same fuction code works with any type $C$. So, we
a fully parametric function of type $(\exists C.\,F^{C})\rightarrow D$
...
\end{lstlisting}
\inputencoding{utf8}As usual with raw tree encodings, the free semigroup\textsf{'}s binary operation
...
The case class \inputencoding{latin9}\lstinline!Wrap!\inputencoding{utf8}
can be removed, and we may reuse the non-empty list type \inputencoding{latin9}\lstinline!NEL!\inputencoding{utf8}
defined in Example~\ref{subsec:Disjunctive-Example-non-empty-list-foldLeft}.
We obtain a reduced encoding of the free semigroup on \inputencoding{latin9}\lstinline!T!\inputencoding{utf8}
as simply \inputencoding{latin9}\lstinline!NEL[T]!\inputencoding{utf8}.
The universal runner is the \inputencoding{latin9}\lstinline!foldMap!\inputencoding{utf8}
...
and \inputencoding{latin9}\lstinline!Op!\inputencoding{utf8}. Thhe
