...
\inputencoding{latin9}\lstinline!NEL!\inputencoding{utf8} and the
corresponding \inputencoding{latin9}\lstinline!foldLeft!\inputencoding{utf8}
and \inputencoding{latin9}\lstinline!concat!\inputencoding{utf8}
functions (see Example~\ref{subsec:Disjunctive-Example-non-empty-list-foldLeft}
...
def runner[S: Semigroup, T](runT: T => S)(freeSemigroup: NEL[T]): S = foldLeft()
\end{lstlisting}
\inputencoding{utf8}
{*}{*}{*}
