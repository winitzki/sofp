...
\textbf{(a)} $\forall A.\,\left(A\times A\times A\rightarrow A\right)\cong\bbnum 1+\bbnum 1+\bbnum 1\quad.$

\textbf{(a)} $\exists Z.\,Z\cong\bbnum 1\quad.$

\textbf{(a)} $\exists Z.\,Z\times\left(A\rightarrow Z\right)\times\left(Z\rightarrow B\right)\cong B\times\left(A\rightarrow B\right)\quad.$
...
\textbf{(a)} $\forall F^{\bullet}.\,F^{A}\rightarrow F^{B}\cong A\rightarrow B\quad.$

\textbf{(a)} $\forall F^{\bullet}.\,\left(A\rightarrow F^{B}\right)\rightarrow F^{B}\cong A\times\left(B\rightarrow B\right)\quad.$

\textbf{(a)} $\forall F^{\bullet}.\,\left(A\rightarrow F^{B}\right)\rightarrow C\rightarrow F^{D}\cong\left(C\rightarrow A\right)\times\left(C\times B\rightarrow D\right)\quad.$
