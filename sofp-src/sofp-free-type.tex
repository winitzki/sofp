...
(a) Implement a monadic DSL with operations put$:A\rightarrow1$ and
get$:A$; run examples. 

(b) Implement a monadic DSL with operations put: $A\rightarrow\bbnum 1$,
get: Option{[}A{]}, and clear: 1, with the functionality that a value
may be deleted (and then get should return None). Run example programs.
