...
the same typeclass. The universal runner for the free monad on \inputencoding{latin9}\lstinline!F!\inputencoding{utf8}
...
\begin{lstlisting}
sealed trait Free5[A]
final case class Pure[A](a: A) extends Free5[A]
final case class Flatten[A](ff: Free5[Free5[A]]) extends Free5[A]
\end{lstlisting}
