...
where \index{Gabriella Gonzalez (Gabriel Gonzalez prior to 2021)}G.~Gonzalez
showed a free monad (in Haskell) corresponding to this Scala code:\inputencoding{latin9}
\begin{lstlisting}
