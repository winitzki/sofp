...
\end{lstlisting}
\inputencoding{utf8}
Does the type constructor \inputencoding{latin9}\lstinline!MonadDSL[F, A]!\inputencoding{utf8}
...
\end{lstlisting}
\inputencoding{utf8}The resulting code will create fewer nested case classes in memory,
which may also improve performance.

Unlike other laws, the right identity law holds for any value \inputencoding{latin9}\lstinline!p!\inputencoding{utf8}
of type \inputencoding{latin9}\lstinline!MonadDSL[F, A]!\inputencoding{utf8}:\inputencoding{latin9}
\begin{lstlisting}
...
enviroment. Since the monad $M$ is arbitrary, it may itself be a
...
\inputencoding{latin9}\lstinline!F!\inputencoding{utf8}, which will
then become the effect constructor of a new monadic DSL. This construction
uses \inputencoding{latin9}\lstinline!F!\inputencoding{utf8} as a
type parameter, and so it works equally well with every \inputencoding{latin9}\lstinline!F!\inputencoding{utf8}. 
...
are not often monadic. The \inputencoding{latin9}\lstinline!MonadDSL!\inputencoding{utf8}
constructor is able to convert \inputencoding{latin9}\lstinline!F!\inputencoding{utf8}
into a monad because the methods \inputencoding{latin9}\lstinline!pure!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!flatMap!\inputencoding{utf8}, and
\inputencoding{latin9}\lstinline!map!\inputencoding{utf8} create
...
at a later time by an effect runner (\inputencoding{latin9}\lstinline!runF!\inputencoding{utf8})
...
a given set of domain-specific operations. But it turns out that \inputencoding{latin9}\lstinline!MonadDSL!\inputencoding{utf8}
...
call \inputencoding{latin9}\lstinline!Free1!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!Free2!\inputencoding{utf8}, and
\inputencoding{latin9}\lstinline!Free3!\inputencoding{utf8}. 

The first example comes from a 2012 blog post\footnote{See \texttt{\href{http://www.haskellforall.com/2012/06/you-could-have-invented-free-monads.html}{http://www.haskellforall.com/2012/06/you-could-have-invented-free-monads.html}}}
where \index{Gabriella Gonzalez (prior to 2021, Gabriel Gonzalez)}G.~Gonzalez
showed a free monad (in Haskell) corresponing to this Scala code:\inputencoding{latin9}
\begin{lstlisting}
...
\end{lstlisting}
\inputencoding{utf8}In a talk given in 2014,\footnote{See \texttt{\href{http://functionaltalks.org/2014/11/23/runar-oli-bjarnason-free-monad/}{http://functionaltalks.org/2014/11/23/runar-oli-bjarnason-free-monad/}}}
...
\end{lstlisting}
\inputencoding{utf8}In 2016, K.~Robinson\index{Kelley Robinson} gave a talk\footnote{See \texttt{\href{https://www.slideshare.net/KelleyRobinson1/why-the-free-monad-isnt-free-61836547}{https://www.slideshare.net/KelleyRobinson1/why-the-free-monad-isnt-free-61836547}}}
...
\end{lstlisting}
\inputencoding{utf8}
Since the differences between \inputencoding{latin9}\lstinline!Free1!\inputencoding{utf8},
\inputencoding{latin9}\lstinline!Free2!\inputencoding{utf8}, and
\inputencoding{latin9}\lstinline!Free3!\inputencoding{utf8} are in
the definitions of the case classes and the \inputencoding{latin9}\lstinline!flatMap!\inputencoding{utf8}
functions, we omitted all other code from these examples. The type
of \inputencoding{latin9}\lstinline!Free3!\inputencoding{utf8} is
the same as \inputencoding{latin9}\lstinline!MonadDSL!\inputencoding{utf8}
...
with curried arguments. However, \inputencoding{latin9}\lstinline!Free1!\inputencoding{utf8}
...
\inputencoding{latin9}\lstinline!F!\inputencoding{utf8} into a monad)
in different ways.

\subsection{The raw tree encoding}

To understand the relationships between the encodings, we first ask:
Does the type \inputencoding{latin9}\lstinline!MonadDSL[F, A]!\inputencoding{utf8}
...
the right identity law. As a result, our code for the \inputencoding{latin9}\lstinline!map!\inputencoding{utf8}
...
that simply create new values of the case classes \inputencoding{latin9}\lstinline!Val!\inputencoding{utf8}
...
The result is a new encoding of the free monad that we may call \inputencoding{latin9}\lstinline!Free4!\inputencoding{utf8}:\inputencoding{latin9}
\begin{lstlisting}
...
\end{lstlisting}
\inputencoding{utf8}
The code of \inputencoding{latin9}\lstinline!Free4!\inputencoding{utf8}
...
\textbf{raw tree encoding}\index{free monad!raw tree encoding}. The
...
that the \inputencoding{latin9}\lstinline!Free3!\inputencoding{utf8}
...
design. The byproduct of that design is that \inputencoding{latin9}\lstinline!Free3!\inputencoding{utf8}
