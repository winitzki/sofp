...
of AFTT, consider applicative functors (see Chapter~\ref{chap:8-Applicative-functors,-contrafunc}).\index{applicative functors}
...
in mathematics as ``lax monoidal'' functors\footnote{\texttt{\href{https://en.wikipedia.org/wiki/Monoidal_functor}{https://en.wikipedia.org/wiki/Monoidal\_functor}}}).\index{applicative functors}
...
``monads,'' \textemdash{} if they were actually \emph{engineers}.
...
embarking on a design project.\begin{wrapfigure}{O}{0.5\textwidth}%
\begin{centering}
...
\par\end{centering}
\caption{Mixing incompatible data types will produce nonsense results.\label{fig:A-nonsensical-calculation}}
