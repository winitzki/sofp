...
\textsf{``}co-product types\textsf{''}, and \textsf{``}tagged union types\textsf{''}. This book uses
the terms \textsf{``}disjunctive types\textsf{''} and \textsf{``}co-product types\textsf{''} interchangeably.}
