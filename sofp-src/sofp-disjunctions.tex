...
expressions. It is usually more convenient to use \lstinline!match!/\lstinline!case!
...
is replaced by an \textsf{``}embedded\textsf{''}\index{embedded \textsf{``}if\textsf{''}} \lstinline!if!
...
created an infinite loop in type recursion\index{infinite loop in type recursion}
