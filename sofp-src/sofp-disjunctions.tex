...
all other cases with an underscore character (\lstinline!case _!):
\begin{lstlisting}
scala> x match {
  case OneRoot(r)   => s"one real root: $r"
...
values (also called the \textbf{void} \textbf{type}\index{void type}).
...
\subsection{The recursive type \texttt{List}}
