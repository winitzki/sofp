...
\begin{itemize}
\item finding and organizing the practice-relevant parts of FP theory
\item verifying theoretical statements by mathematical derivations
\end{itemize}
...
mistakes
\begin{itemize}
\item In Scala, just return \texttt{\textcolor{blue}{\footnotesize{}Try{[}Result{]}}}
