...
\begin{itemize}
\item Learning from papers, books, online tutorials, and meetups
...
\begin{itemize}
\item What do the monad laws ensure? How to verify those laws?
\item When is a data structure a functor (or monad, or applicative)?
\end{itemize}
\end{itemize}
...
\end{itemize}
\item Abstract, ``academic'' theory with no applications in programming
\begin{itemize}
...
\item ``\href{https://en.wikipedia.org/wiki/Monad_(category_theory)\#Monads_arising_from_adjunctions}{Any monad comes from an explicit adjunction of some functors}''
\end{itemize}
\end{itemize}
\end{frame}
...
I am writing a \href{https://leanpub.com/sofp}{new book} to answer
all my FP questions
\begin{itemize}
...
\begin{itemize}
\item For example, \texttt{\textcolor{blue}{\footnotesize{}Either{[}A, (A,
A, A){]}}} is a lawful monad
\end{itemize}
\end{itemize}
\item This is a rigorous result (programmers do not need to test it)
\begin{itemize}
...
The \texttt{\textcolor{blue}{\footnotesize{}map}}/\texttt{\textcolor{blue}{\footnotesize{}filter}}/\texttt{\textcolor{blue}{\footnotesize{}reduce}}
...
\textcolor{blue}{\footnotesize{}~~~~~|~~~4~==~(2~to~n).count~\{~x~=>~n~\%~x~==~0~\&\&~x~{*}~x~<=~n~\}}{\footnotesize\par}
...
\begin{itemize}
\item Algebraic data types, such as \texttt{\textcolor{blue}{\footnotesize{}(A,
Either{[}String, Option{[}A{]}{]})}}{\footnotesize\par}
