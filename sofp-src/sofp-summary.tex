...
\]
where all functions are assumed to be fully parametric. Can one find
...
Here are some known facts about $F^{R}$. It follows from the covariant
...
So, $F^{R}$ is not equivalent to the function type $R\rightarrow R$.
