...
each $F$-effect exactly once. (Can one use the composition of an
...
and \lstinline!flatMap! methods are implemented via fully parametric
code? Given the code for an arbitrary monad, can one derive an implementation
