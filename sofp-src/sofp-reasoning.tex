...
programs. We will now define the code notation for each of these eight
constructions, as summarized in Table~\ref{tab:Mathematical-notation-for-basic-code-constructions}. 
...
unit values are denoted by \lstinline!1! and are viewed as having
type $\bbnum 1$. 
