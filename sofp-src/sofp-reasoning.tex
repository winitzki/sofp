...
expression (Scala's \lstinline!match!/\lstinline!case! syntax).
Recall that functions that take a disjunctive value as an argument
(``\index{disjunctive functions}\textbf{disjunctive functions}'')
...
A useful tool for calculations is the \textbf{pipe}\index{pipe notation}\index{\$@$\triangleright$-notation!see ``pipe notation''}
...
called the ``naturality law\index{naturality law!of merge@of \texttt{merge}}'':
