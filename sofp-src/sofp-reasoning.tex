...
For any functors $F$, $G$, $K$, $L$ and any natural transformation
...
are both also natural transformations. The \textbf{pair co-product}\index{pair co-product}
of two functions $\phi$ and $\psi$ is defined by
\[
\phi\boxplus\psi\triangleq\begin{array}{|c||cc|}
 & G^{A} & L^{A}\\
