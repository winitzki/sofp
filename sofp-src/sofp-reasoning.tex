...
We may also use a \textsf{``}named unit\index{unit type!named}\textsf{''}, e.g.~\lstinline!None!
...
these functions are unlikely to be frequently used in practical programming.) 
