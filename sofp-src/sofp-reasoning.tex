...
\end{tabular}
\par\end{centering}
\caption{Mathematical code notation for the nine basic code constructions.\label{tab:Mathematical-notation-for-basic-code-constructions}}
\end{table}
...
for the \lstinline!List! functor is defined as:
\[
...
it follows that the composition $f\bef g$ satisfies this equation:
\[
...
law\index{associativity law!of merge@of \texttt{merge}}\textsf{''} of \lstinline!merge!:
