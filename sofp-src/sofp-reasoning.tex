...
for each of the eight constructions. 
...
getting used to. At first, it may help to write the matrices with
all type annotations. This helps translate between Scala code and
the matrix notation.
...
With this definition, we can formulate a law for \lstinline!merge!,
...
\]
To verify the identity law for $L$:
\begin{align*}
...
To verify the composition law for $L$, we assume two arbitrary functions
