...
are not pursued beyond proven practical relevance or direct pedagogical
usefulness. This reduces the required mathematical knowledge to first
notions of set theory, formal logic, and category theory. Concepts
such as functors or natural transformations arise organically from
the practice of reasoning about code and are first introduced without
reference to category theory. This book does not use \textsf{``}introduction/elimination
...
as learning these concepts will neither help programmers write code
nor answer any practical questions about code. 
