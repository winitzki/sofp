...
\emph{vita brevis, ars longa}. The scope of the required mathematical
...
\end{align*}
When the two-column presentation becomes too wide, the explanations
are placed before the next step\textsf{'}s line:
\begin{align*}
