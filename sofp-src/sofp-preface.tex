...
need to learn some difficult concepts through prolonged mental concentration
...
ideas, notations, and Scala language features from scratch. The aim
...
reference to category theory. This book does not use ``introduction/elimination
...
is in Section~\ref{subsec:Aggregation-solved-examples}, which belongs
to Chapter~\ref{chap:1-Values,-types,-expressions,}.
