...
The goal of this book is to teach functional programmers how to reason
mathematically about types and code, in a way that is directly relevant
...
Readers familiar with functional programming could skim the glossary
(Appendix~\ref{chap:Appendix-Glossary-of-terms}) to see the unfamiliar
terminology and then begin the book at Chapter~\ref{chap:3-3-The-formal-logic-curry-howard}.
...
that guide the practice of functional programming \textemdash{} that
...
through code examples. Only then a set of mathematical equations is
derived and the laws are formulated as equations.
