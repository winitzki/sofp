...
Machin's formula\footnote{\texttt{\href{http://turner.faculty.swau.edu/mathematics/materialslibrary/pi/machin.html}{http://turner.faculty.swau.edu/mathematics/materialslibrary/pi/machin.html}}}
...
for the Riemann zeta function $\zeta(4)$; it is known\footnote{\texttt{\href{https://ocw.mit.edu/courses/mathematics/18-104-seminar-in-analysis-applications-to-number-theory-fall-2006/projects/chan.pdf}{https://tinyurl.com/yxey4tsd}}}
...
\hline 
LISP & 1958 & \texttt{\footnotesize{}}\lstinline!(lambda (k) (+ k k))!\tabularnewline
\hline 
Standard ML & 1973 & \texttt{\footnotesize{}}\lstinline!fn (k:int) => k + k!\tabularnewline
\hline 
Scheme & 1975 & \texttt{\footnotesize{}}\lstinline!(lambda (k) (+ k k))!\tabularnewline
\hline 
OCaml & 1985 & \lstinline!fun (k:int) -> k + k!\tabularnewline
\hline 
Haskell  & 1990 & \lstinline!\ k -> (k::Int) + k!\tabularnewline
\hline 
Oz & 1991 & \lstinline!fun {$ K} K + K!\tabularnewline
\hline 
R  & 1993 & \lstinline!function(k) k + k!\tabularnewline
\hline 
Python 1.0 & 1994 & \lstinline!lambda k: k + k!\tabularnewline
\hline 
JavaScript  & 1995 & \lstinline!function(k) { return k + k; }!\tabularnewline
\hline 
Mercury  & 1995 & \lstinline!func(K) = K + K!\tabularnewline
\hline 
Ruby  & 1995 & \lstinline!lambda { |k| k + k }!\tabularnewline
\hline 
Lua 3.1 & 1998 & \lstinline!function(k) return k + k end!\tabularnewline
\hline 
Scala  & 2003 & \lstinline!(k:Int) => k + k!\tabularnewline
\hline 
F\# & 2005 & \lstinline!fun (k:int) -> k + k!\tabularnewline
\hline 
C\# 3.0 & 2007 & \lstinline!delegate(int k) { return k + k; }!\tabularnewline
\hline 
C++ 11 & 2011 & \lstinline![] (int k) { return k + k; }!\tabularnewline
\hline 
Go & 2012 & \lstinline!func(k int) { return k + k }!\tabularnewline
\hline 
Kotlin & 2012 & \lstinline!{ k:Int -> k + k }!\tabularnewline
\hline 
Swift  & 2014 & \lstinline!{ (k:int) -> int in return k + k }!\tabularnewline
\hline 
Java 8 & 2014 & \lstinline!(int k) -> k + k!\tabularnewline
\hline 
Rust & 2015 & \lstinline!|k:i32| k + k!\tabularnewline
\hline 
\end{tabular}
\par\end{centering}
