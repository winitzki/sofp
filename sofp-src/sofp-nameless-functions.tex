...
some often used mathematical constructions in Scala. The Scala standard
library also contains methods such as \lstinline!takeWhile! that
do not correspond to widely used mathematical symbols.
...
What problems can one solve with the techniques shown in this chapter?
\begin{itemize}
