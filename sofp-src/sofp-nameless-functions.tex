...
``Nameless'' mathematical functions may be denoted using the symbol
$\rightarrow$ (pronounced ``maps to'') like this: 
\[
...
and aggregation is known as programming in the \textbf{map/reduce}\index{map/reduce style@\texttt{map}/\texttt{reduce} style}
\textbf{style}.
...
function, function expression, function literal, closure, \index{lambda-functions!see ``nameless functions''}lambda
