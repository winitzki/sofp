...
of \lstinline!fac!. An alternative Scala interpreter called \lstinline!ammonite!\footnote{\texttt{\href{https://ammonite.io/}{https://ammonite.io/}}}
prints this:
\begin{lstlisting}
scala@ val fac = (n: Int) => (1 to n).product  //IGNORETHIS
fac: Int => Int = ammonite.$sess.cmd0$$$Lambda$1675/2107543287@1e44b638
\end{lstlisting}
The long number could indicate an address in memory. So, we may imagine
...
\lstinline!filter!, and \lstinline!sum!, that implement certain
...
all functions required names. But by 2015, most languages had support
for nameless functions. This happened largely because programming
in the map/reduce style\index{map/reduce programming style@\texttt{map}/\texttt{reduce} programming style}
...
function, lambda expression, or just a \textsf{``}lambda\textsf{''}. This book prefers
