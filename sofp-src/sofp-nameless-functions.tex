...
the argument \texttt{}\lstinline!k! of the nameless function \lstinline*k => n % k != 0*.
The Scala compiler knows that \texttt{}\lstinline!k! is going to
iterate over the \emph{integer} elements of the range \lstinline!(2 to n-1)!,
