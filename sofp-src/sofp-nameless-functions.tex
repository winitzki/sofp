...
\tabularnewline
\hline 
${\displaystyle \sum_{k\in S\text{ such that }p(k)\text{ holds}}}f(k)$ & 
\begin{lstlisting}
...
\hline 
LISP & 1958 & \texttt{\footnotesize{}}
\begin{lstlisting}
(lambda (k) (+ k k))
\end{lstlisting}
\tabularnewline
\hline 
Standard ML & 1973 & \texttt{\footnotesize{}}
\begin{lstlisting}
fn (k:int) => k + k
\end{lstlisting}
\tabularnewline
\hline 
Scheme & 1975 & \texttt{\footnotesize{}}
\begin{lstlisting}
(lambda (k) (+ k k))
\end{lstlisting}
\tabularnewline
