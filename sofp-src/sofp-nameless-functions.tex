...
uses the symbol $\Rightarrow$ (pronounced ``maps to''). However,
...
Another distinctive feature of the FP paradigm is handling iteration
...
evaluate a formula such as $x^{2}+x$ ten times, or to ``repeat''
an equation such as
\[
