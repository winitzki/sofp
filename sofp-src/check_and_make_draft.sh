...
pagecounts=(3 17 42 34 24 49 43 12 63 54 63 10 6 24 144 4 5 6 3 6 6 3 5 17 16 1 2 1 1 5)
...
chapters=("Preface" "Mathematical formulas as code. I." \
 ...
 "D Parametricity theorem" "E Solutions to some exercises" "F A humorous disclaimer" "G GNU Free Documentation License" \
