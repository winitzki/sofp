...
Chapters 13 and 14:
\begin{itemize}
\item The ``tagless final'' is just a Church encoding of the free monad
\item A complete proof of the correctness of the Church encoding is hard
\begin{itemize}
...
\item The difficulty is similar to undergraduate-level engineering
\end{itemize}
