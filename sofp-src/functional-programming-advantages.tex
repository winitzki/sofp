...
\textcolor{blue}{\footnotesize{}{[}~(x,~y)~for~x~in~array~for~y~in~array~{]}}{\footnotesize\par}
...
\textcolor{blue}{\footnotesize{}givenArray}{\footnotesize\par}

\textcolor{blue}{\footnotesize{}~~.filter~\{~x~=>~(x~>=~0)~\}}{\footnotesize\par}

\textcolor{blue}{\footnotesize{}~~.map(math.sqrt)}{\footnotesize\par}
