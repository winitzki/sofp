...
and can be generalized into a \textsf{``}monad\textsf{''}\index{monads}, a versatile
and powerful design pattern in functional programming. In this chapter,
...
lazy and on-call streams with value-like behavior.
