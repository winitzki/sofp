...
value is followed by a larger value. For example, the input sequence
...
the fixed types \lstinline!Int! and \lstinline!String!. The return
type of the function should be \lstinline!Map[P, Q]!. Run some tests
