...
if $R$ is any rigid monad and $H$ is any $R$-filterable contrafunctor.
\end{enumerate}
...
So, we will need to prove only constructions~1, 2, and~4.
...
If we flip the curried arguments of the Kleisli morphism type $A\rightarrow H^{M^{B}}\rightarrow M^{B}$
