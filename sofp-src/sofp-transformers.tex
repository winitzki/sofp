...
programming; say, for every exponential-polynomial type constructor
whose monad methods are lawful and are implemented by purely functional
code.\footnote{Monad transformers may certainly fail to exist for monads defined
