...
of monads}.\footnote{\textsf{``}\emph{What\textsf{'}s the big deal?}\textsf{''} as the joke would go.}
...
\subsection{Monadically natural lifting of MTL operations (Jaskelioff\textsf{'}s \textsf{``}\texttt{Monatron}\textsf{''})\label{subsec:Monatron}}
