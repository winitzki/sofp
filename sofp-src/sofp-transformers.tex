...
are \emph{not} isomorphisms between the monads $F$ and $\text{Cod}^{F,\bullet}$.
...
As for the function \lstinline!outC!, it satisfies the identity law
of monad morphisms:
\begin{align*}
...
{\color{greenunder}\text{identity law of }R:}\quad & =\gunderline{\text{pu}_{S}^{\uparrow R}\bef\text{ftn}_{S}^{\uparrow R}}\\
