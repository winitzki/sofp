...
where the \lstinline!swap! function obeys the outer-identity and
...
$K$ is the monad $L^{A}\triangleq A+K^{A}$ (see Statement~\ref{subsec:Statement-co-product-with-identity-monad}). 
