...
Begin with the right-hand side and use Eq.~(\ref{eq:comb-defined-via-helper-function-c}):
\begin{align*}
 & \text{comb}\,(p\triangleright\text{ftn}_{T})(q\triangleright\text{ftn}_{T})=p\triangleright\text{ftn}_{T}\triangleright\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\\
 & =p\triangleright\text{flm}_{M}(\text{prod})\bef\text{flm}_{M}(q\triangleright\text{flm}_{M}(\text{prod})\bef c)\\
 & =p\triangleright\text{flm}_{M}\big(\text{prod}\bef\text{flm}_{M}(q\triangleright\text{flm}_{M}(\text{prod})\bef c)\big)
\end{align*}
...
\begin{align*}
 ...
 & =p\triangleright\text{flm}_{M}((q\triangleright c)\bef\text{flm}_{M}(\text{prod}))
\end{align*}
compare
\[
\text{prod}\bef\text{flm}_{M}(q\triangleright\text{flm}_{M}(\text{prod})\bef c)\overset{?}{=}(q\triangleright c)\bef\text{flm}_{M}(\text{prod})
\]
b
\begin{align*}
 & \text{prod}\bef\text{flm}_{M}(q\triangleright\text{flm}_{M}(\text{prod})\bef c)=\,\begin{array}{||c|}
1\rightarrow\text{Nil}\triangleright\text{pu}_{M}\bef\text{flm}_{M}(q\triangleright\text{flm}_{M}(\text{prod})\bef c)\\
m\times p\rightarrow\text{comb}\,(m)(p\triangleright\overline{\text{prod}}^{\uparrow M}\bef\text{ftn}_{M})\triangleright\text{flm}_{M}(q\triangleright\text{flm}_{M}(\text{prod})\bef c)
\end{array}\\
 & =***
\end{align*}
c
\begin{align*}
 & (q\triangleright c)\bef\text{flm}_{M}(\text{prod})=\,\begin{array}{||c|}
...
\end{array}\\
 & =\,\begin{array}{||c|}
1\rightarrow q\triangleright\text{flm}_{M}(\text{prod})\\
a\times p\rightarrow\big(\bbnum 0^{:\bbnum 1}+a\times\overline{\text{comb}}\,(p)(q)\big)\,\gunderline{\triangleright\text{prod}}
\end{array}\,=\,\begin{array}{||c|}
1\rightarrow q\triangleright\text{flm}_{M}(\text{prod})\\
a\times p\rightarrow\text{comb}\,(a)\big((\overline{\text{comb}}\,(p)(q))\triangleright\overline{\text{ftn}}_{T}\big)
\end{array}
\end{align*}
a
\begin{align*}
 & \text{prod}=\,\begin{array}{|c||c|}
 & M^{L^{A}}\\
\hline \bbnum 1 & 1\rightarrow\text{Nil}\triangleright\text{pu}_{M}\\
M^{L^{A}}\times M^{L^{M^{L^{A}}}} & m\times p\rightarrow\text{comb}\,(m)(p\triangleright\overline{\text{prod}}^{\uparrow M}\bef\text{ftn}_{M})
\end{array}\,=\\
...
and write:
\begin{align*}
{\color{greenunder}\text{expect to equal }\text{id}:}\quad & \text{pu}_{L}\bef\text{prod}=\,\begin{array}{||cc|}
...
sub-list. To demonstrate the truncating behavior more simply, take
