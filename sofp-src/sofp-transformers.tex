...
\subsection{Combining effects by functor composition}
...
Functor composition, \lstinline!Future[Option[A]]!, is one way of
combining two functors. Consider this code:
\begin{lstlisting}
\end{lstlisting}
