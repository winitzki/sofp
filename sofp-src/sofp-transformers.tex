...
\[
p:\big((A\rightarrow L^{Q})\rightarrow L^{A}\big)\rightarrow(A\rightarrow T_{L}^{\text{Id},Q})\rightarrow T_{L}^{\text{Id},A}\quad,\quad\quad q:\big((A\rightarrow T_{L}^{\text{Id},Q})\rightarrow T_{L}^{\text{Id},A}\big)\rightarrow(A\rightarrow L^{Q})\rightarrow L^{A}\quad,
\]
such that $p\bef q=\text{id}$ and $q\bef p=\text{id}$. We may assume
that the identity laws hold for the transformer $T_{L}$. These laws
give us two monad morphisms $r:T_{L}^{\text{Id},A}\rightarrow L^{A}$
and $s:L^{A}\rightarrow T_{L}^{\text{Id},A}$ that satisfy $r\bef s=\text{id}$
and $s\bef r=\text{id}$. 
