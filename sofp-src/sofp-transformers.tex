...
satisfy a \textbf{non-degeneracy law}:\index{monad transformers!non-degeneracy law}
\[
...
\subsection{Monadically natural lifting of MTL operations (Jaskelioff\textsf{'}s \texttt{Monatron})}
...
It turns out that the lifted operations are the same:
...
as $\text{op}_{P}=\text{sop}_{P}\bef\text{ftn}_{P}$.

\paragraph{Proof}

Substitute $\text{op}=\text{sop}\bef\text{ftn}_{M}$ into Eq.~(\ref{eq:monatron-op-P-via-cop})
and rewrite:
\begin{align*}
 & \text{op}_{P}=(\text{frun}_{L}(\text{inC}))^{\uparrow F}\bef\gunderline{\text{cop}_{P^{\prime}}}\bef\text{frun}_{L}(\text{outC})\\
{\color{greenunder}\text{definition of }\text{cop}_{P^{\prime}}:}\quad & =(\text{frun}_{L}(\text{inC}))^{\uparrow F}\bef\gunderline{\text{scop}_{P^{\prime}}}\bef\text{ftn}_{P^{\prime}}\bef\text{frun}_{L}(\text{outC})\\
{\color{greenunder}\text{definition of }\text{scop}_{P^{\prime}}:}\quad & =\gunderline{(\text{frun}_{L}(\text{inC}))^{\uparrow F}\bef\text{scop}}\bef\text{flift}_{L}^{\text{Cod}}\bef\text{ftn}_{P^{\prime}}\bef\text{frun}_{L}(\text{outC})\\
{\color{greenunder}\text{naturality law of }\text{scop}:}\quad & =\text{scop}\bef\gunderline{(\text{frun}_{L}(\text{inC}))^{\uparrow\text{Cod}}\bef\text{flift}_{L}^{\text{Cod}}}\bef\text{ftn}_{P^{\prime}}\bef\text{frun}_{L}(\text{outC})\\
{\color{greenunder}\text{naturality law of }\text{flift}_{L}:}\quad & =\text{scop}\bef\text{flift}_{L}^{\text{Cod}}\bef(\text{frun}_{L}(\text{inC}))^{\uparrow P^{\prime}}\bef\text{ftn}_{P^{\prime}}\bef\text{frun}_{L}(\text{outC})
\end{align*}
 {*}{*}{*}
\begin{align*}
(F\circ P & \leadsto P)=(F\circ P\leadsto F\circ P^{\prime})\bef(F\circ P^{\prime}\leadsto P^{\prime})\bef(P^{\prime}\leadsto P)\\
 & =(F\circ P\leadsto F\circ P^{\prime})\bef(F\circ P^{\prime}\leadsto P^{\prime}\circ P^{\prime})\bef(P^{\prime}\circ P^{\prime}\leadsto P)\bef(P^{\prime}\leadsto P)\\
 & =(F\circ P\leadsto F\circ P^{\prime})\bef(F\circ P^{\prime}\leadsto\text{Cod}\circ P^{\prime})\bef(\text{Cod}\circ P^{\prime}\leadsto P^{\prime}\circ P^{\prime})\bef(P^{\prime}\circ P^{\prime}\leadsto P)\bef(P^{\prime}\leadsto P)\\
 & =(F\circ P\leadsto\text{Cod}\circ P)\bef(\text{Cod}\circ P\leadsto\text{Cod}\circ P^{\prime})\bef(\text{Cod}\circ P^{\prime}\leadsto P^{\prime}\circ P^{\prime})\bef(P^{\prime}\circ P^{\prime}\leadsto P)\bef(P^{\prime}\leadsto P)\\
 & =(F\circ P\leadsto\text{Cod}\circ P)\bef(\text{Cod}\circ P\leadsto P^{\prime}\circ P)\bef(P^{\prime}\circ P\leadsto P^{\prime}\circ P^{\prime})\bef(P^{\prime}\circ P^{\prime}\leadsto P)\bef(P^{\prime}\leadsto P)
\end{align*}
{*}{*}{*}

We need to show that $\text{sop}_{P}=?$

The lifted version $\text{sop}_{P}$ of $\text{sop}$ is related to
$\text{scop}_{P^{\prime}}$ by $\text{sop}_{P}\triangleq\text{scop}_{P^{\prime}}\bef\text{flift}_{L}(\text{outC})$.

{*}{*}{*}
\begin{align*}
 & \text{scop}=f\rightarrow k\rightarrow f\triangleright k^{\uparrow F}\bef\text{sop}\bef\text{ftn}_{M}=f\rightarrow k\rightarrow f\triangleright\text{sop}\bef k^{\uparrow M}\bef\text{ftn}_{M}\\
\end{align*}
...
\[
\text{blift}_{M}\bef\text{op}_{Q}=\text{pu}_{N}\bef\text{op}^{\uparrow N}=\text{op}\bef\text{pu}_{N}=\text{op}\bef\text{blift}_{M}\quad.
\]
...
type parameter $B$ appears only once in the type expression and is
in a covariant position. So, we can set $B=\bbnum 0$ in the type
of \lstinline!calcc! and obtain an equivalent type
\[
...
and \lstinline!outS!:
\begin{align*}
 & \text{inS}:(A\rightarrow R)\rightarrow((A\rightarrow R)\rightarrow R)\rightarrow R\quad,\quad\quad\text{inS}\triangleq k^{:A\rightarrow R}\rightarrow p^{:(A\rightarrow R)\rightarrow R}\rightarrow p(k)\quad,\\
 & \text{outS}:\big(((A\rightarrow R)\rightarrow R)\rightarrow R\big)\rightarrow A\rightarrow R\quad,\quad\quad\text{outS}\triangleq p^{:((A\rightarrow R)\rightarrow R)\rightarrow R}\rightarrow a^{:A}\rightarrow p(k^{:A\rightarrow R}\rightarrow k(a))\quad.
\end{align*}
To prove the injective and surjective properties, we will show that
$\text{inS}\bef\text{outS}=\text{id}$:
\begin{align*}
{\color{greenunder}\text{expect to equal }k:}\quad & k^{:A\rightarrow R}\triangleright\text{inS}\triangleright\text{outS}=(p\rightarrow p(k))\triangleright\text{outS}=a\rightarrow(p\rightarrow p(k))(k\rightarrow k(a))\\
...
is wrapped by the functor $(\bullet\rightarrow\text{Cont}^{R,A})\rightarrow\text{Cont}^{R,A}$(where
we fix the types $A$ and $R$). Denoting that functor by $G$, we
can write a function transforming the type of \lstinline!cc! into
the type of \lstinline!callcc! as:
\[
\text{outS}^{\uparrow G}:G^{((A\rightarrow R)\rightarrow R)\rightarrow R}\rightarrow G^{A\rightarrow R}\quad.
\]
...
in the type of $h$, and insert an ignored argument of type $B\rightarrow R$
when $h$ is applied: 
\[
...
The result is
\begin{align*}
 & \text{callcc}=h^{:(A\rightarrow\text{Cont}^{R,B})\rightarrow\text{Cont}^{R,A}}\rightarrow\text{cc}\,\big(s^{:\text{Cont}^{R,A\rightarrow R}}\rightarrow h(a^{:A}\rightarrow\_^{:B\rightarrow R}\rightarrow s(\text{pu}_{\text{Cont}}(a)))\big)\\
 & =h^{:(A\rightarrow\text{Cont}^{R,B})\rightarrow\text{Cont}^{R,A}}\rightarrow\text{cc}\,\big(s^{:\text{Cont}^{R,A\rightarrow R}}\rightarrow h(a^{:A}\rightarrow\text{jump}(s(\text{pu}_{\text{Cont}}(a))))\big)\\
...
\]
Finally, the lifted operation $\text{callcc}_{P}$ is defined through
$\text{cc}_{P}$ by
\[
...
\]
In this way, we reproduce the behavior of the \lstinline!callcc!
...
Show that this \textsf{``}standard\textsf{''} operation is equivalent to a \textsf{``}simple\textsf{''}
operation.
...
\[
\text{ftn}_{M}^{\uparrow M}\bef\text{op}=\text{ftn}_{M}^{\uparrow M}\bef\text{ftn}_{M}=\text{ftn}_{M}\bef\text{ftn}_{M}=\text{op}\bef\text{ftn}_{M}\quad.
\]
...
a \textsf{``}standard\textsf{''} operation $\text{op}:F^{M}\leadsto M$. Is this \textsf{``}standard\textsf{''}
...
constructor $F=F_{1}+F_{2}+...$ and use a free monad on $F$ to implement
all the operations at once. But a free monad cannot describe any operations
that are not equivalent to \textsf{``}simple\textsf{''} ones.
