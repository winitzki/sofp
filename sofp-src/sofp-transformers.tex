...
{\color{greenunder}\text{naturality law of }\text{pu}_{L}:}\quad & =\text{ftn}_{M}\bef\text{pu}_{L}\quad.
\end{align*}
...
\subsection{The codensity monad and its transformer. Proofs}
...
\noindent monad $T\triangleq R\circ S$ and is defined by 
\begin{equation}
