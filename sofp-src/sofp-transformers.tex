...
is a monadically natural lifting of \lstinline!op!.

\subparagraph{Proof}

The lifting of $M$ to $P$ is given by \lstinline!flift!. To verify
the monadic naturality law:
\begin{align*}
{\color{greenunder}\text{expect to equal }\text{op}\bef\text{flift}:}\quad & \text{flift}_{L}^{\uparrow F}\bef\text{op}_{P}=\text{flift}_{L}^{\uparrow F}\bef(\text{frun}_{L}(\text{inC}))^{\uparrow F}\bef\text{cop}_{P^{\prime}}\bef\text{frun}_{L}(\text{outC})\\
...
{\color{greenunder}\text{monadic naturality law of }\text{flift}_{L}:}\quad & =\big(\text{inC}\bef\text{flift}_{L}\big)^{\uparrow F}\bef\text{scop}\bef\text{flift}_{L}\bef\text{ftn}_{P^{\prime}}\bef\text{frun}_{L}(\text{outC})\\
 & =\big(\text{inC}\bef\text{flift}_{L}\big)^{\uparrow F}\bef(f\rightarrow k\rightarrow f\triangleright k^{\uparrow F}\bef\text{op})\bef\text{flift}_{L}\bef\text{ftn}_{P^{\prime}}\bef\text{frun}_{L}(\text{outC})
\end{align*}
