...
with $F^{A}\triangleq A\times A$. As shown in Exercise~\ref{subsec:Exercise-flatten-concat-distributive-law},
\lstinline!append! satisfies the compatibility law~(\ref{eq:monatron-standard-operation-compatibility-law}).
So, Statement~\ref{subsec:Statement-simple-standard-operations-monatron}
