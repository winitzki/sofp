...
\textbf{(a)} When $f$ is any function between two types $R$ and
$S$, show that there exists a lawful monad morphism of type $\text{Reader}^{S,A}\rightarrow\text{Reader}^{R,A}$. 

\textbf{(b)} When $f$ is any \emph{monoid} morphism between monoids
$R$ and $S$, show that there exists a lawful monad morphism of type
$\text{Writer}^{R,A}\rightarrow\text{Writer}^{S,A}$.
