...
transformers just mentioned. Instead, as shown in the following statement,
the \lstinline!flatten! method of $T_{\text{List}}$ is defined via
a special helper function named \lstinline!prod!\footnote{The function \lstinline!prod! was studied in the paper \textsf{``}Composing
...
\end{array}\quad.
\]
The function \lstinline!prod! then satisfies certain special laws,
proved in Statement~\ref{subsec:Statement-laws-of-prod-for-effectful-list}
...
\end{array}\quad.
\]
The base runner will then have the type signature $M^{L^{R}}\rightarrow M^{R}$.
The code for \lstinline!brun! aggregates all elements of the effectful
list into a single value of type $M^{R}$:
\[
...
\end{array}\,\bigg)\quad.
\]
Here, we used the monoid operation $\oplus_{M}$ of the monoid $M^{R}$,
defined by
\[
...
\begin{align}
 & \text{comb}\,(m)(n)\triangleq m\triangleright\text{flm}_{M}(n\triangleright c)=m\triangleright(n\triangleright c)^{\uparrow M}\bef\text{ftn}_{M}\quad,\label{eq:comb-defined-via-helper-function-c}\\
{\color{greenunder}\text{where }c\text{ is defined by}:}\quad & n\triangleright c\triangleq\,\begin{array}{|c||c|}
 & M^{L^{A}}\\
\hline \bbnum 1 & 1\rightarrow n\\
A\times M^{L^{A}} & a\times p\rightarrow\text{pu}_{M}\big(\bbnum 0^{:\bbnum 1}+a\times\overline{\text{comb}}\,(p)(n)\big)
\end{array}\quad.\nonumber 
...
\subsubsection{Statement \label{subsec:Statement-monoid-operation-comb-for-effectful-list-1}\ref{subsec:Statement-monoid-operation-comb-for-effectful-list-1}}
...
Begin with the left-hand side of the distributive law and use Eq.~(\ref{eq:comb-defined-via-helper-function-c}):
\begin{align*}
 & \big(\text{comb}\,(p)(q)\big)\triangleright\text{ftn}_{T}=p\triangleright\text{flm}_{M}(q\triangleright c)\triangleright\text{ftn}_{T}=p\triangleright\text{flm}_{M}(q\triangleright c)\bef\text{flm}_{M}(\text{prod})\\
{\color{greenunder}\text{associativity of }\text{flm}_{M}:}\quad & =p\triangleright\text{flm}_{M}((q\triangleright c)\bef\text{flm}_{M}(\text{prod}))\quad.
\end{align*}
Rewrite the right-hand side of the distributive law:
\begin{align*}
 & \text{comb}\,(p\triangleright\text{ftn}_{T})(q\triangleright\text{ftn}_{T})=p\triangleright\gunderline{\text{ftn}_{T}}\triangleright\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\\
 & =p\triangleright\text{flm}_{M}(\text{prod})\bef\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\\
{\color{greenunder}\text{associativity of }\text{flm}_{M}:}\quad & =p\triangleright\text{flm}_{M}\big(\text{prod}\bef\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\big)\quad.
\end{align*}
It remains to prove the following equality between functions of type
$L^{T^{A}}\rightarrow T^{A}$:
\[
\text{prod}\bef\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\overset{?}{=}(q\triangleright c)\bef\text{flm}_{M}(\text{prod})\quad.
\]
Since we do not have a matrix representation for $\text{flm}_{M}$,
it is not convenient to use matrices throughout this derivation. Instead,
we will substitute an arbitrary value of type $L^{T^{A}}\cong\bbnum 1+T^{A}\times T^{T^{A}}$
...
\begin{align*}
{\color{greenunder}\text{left-hand side}:}\quad & \gunderline{\text{Nil}\triangleright\text{prod}}\bef\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)=\text{Nil}\triangleright\gunderline{\text{pu}_{M}\bef\text{flm}_{M}}(q\triangleright\text{ftn}_{T}\triangleright c)\\
{\color{greenunder}\text{identity law of }M:}\quad & =\text{Nil}\triangleright(q\triangleright\text{ftn}_{T}\triangleright c)\quad.
\end{align*}
Since 
\[
\text{Nil}\triangleright(s\triangleright c)=\,\begin{array}{|cc|}
...
we can simplify
\[
\text{Nil}\triangleright(q\triangleright\text{ftn}_{T}\triangleright c)=q\triangleright\text{ftn}_{T}\quad.
\]
Substituting $\text{Nil}$ into the right-hand side yields:
\[
\text{Nil}\triangleright(q\triangleright c)\triangleright\text{flm}_{M}(\text{prod})=q\triangleright\text{flm}_{M}(\text{prod})=q\triangleright\text{ftn}_{T}\quad.
\]
Both sides are now equal.
...
\begin{align*}
 & (\bbnum 0+h\times t)\triangleright\text{prod}\bef\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\\
...
\end{array}\,\bef\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\\
{\color{greenunder}\text{apply matrix}:}\quad & =\big(\text{comb}\,(h)(t\triangleright\text{ftn}_{T})\big)\triangleright\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\quad.
\end{align*}
Substituting $\bbnum 0+h\times t$ into the right-hand side:
\begin{align*}
 & (\bbnum 0+h\times t)\triangleright(q\triangleright c)\bef\text{flm}_{M}(\text{prod})\\
...
{\color{greenunder}\text{definition~(\ref{eq:definition-of-comb-for-effectful-list}) of }\text{comb}:}\quad & =\big(\text{comb}\,(h)((t\triangleright\text{ftn}_{T}))\big)\triangleright\text{flm}_{M}(q\triangleright\text{ftn}_{T}\triangleright c)\quad.
\end{align*}
...
The function \lstinline!prod! satisfies the laws~(\ref{eq:identity-laws-of-prod-for-effectful-list})\textendash (\ref{eq:associativity-law-of-prod-for-effectful-list})
and~(\ref{eq:monadic-naturality-law-of-prod-for-list-transformer}).
...
\end{align*}
We find that the code matrix for $\text{pu}_{T}^{\uparrow L}\bef\text{prod}$
is
\begin{align*}
...
\begin{align*}
 & \text{prod}\bef\text{prod}^{\uparrow M}\bef\text{ftn}_{M}\\
 & \text{prod}^{\uparrow M\uparrow L}\bef\text{ftn}_{M}^{\uparrow L}\bef\text{prod}\\
\end{align*}
