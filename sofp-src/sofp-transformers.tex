...
These laws guarantee the existence of the most general forms of lifts
and runners. The monad transformers for linear monads, rigid monads,
product monads, free pointed monads, and recursive monads are complete,
as we have proved in the previous sections. We now consider certain
monads whose transformers are deficient in one or another way, so
that they are not, strictly speaking, lawful pointed and co-pointed
functors in the category of monads. Those deficiencies lead to certain
