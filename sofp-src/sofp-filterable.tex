...
lifted function, the law must have the form:\begin{wrapfigure}{L}{0.3\columnwidth}%
...
\]
as illustrated by the type diagram on the left. The types will match
in the right-hand side only if the argument of \lstinline!deflate!
is of type $F^{\bbnum 1+B}$. So, the law must have the form: 
\[
...
law\index{naturality law!of liftOpt@of \texttt{liftOpt}} (see diagram
at left):
\begin{equation}
