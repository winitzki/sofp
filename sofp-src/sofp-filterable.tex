...
a predicate $p^{:A\rightarrow\bbnum 2}$ and looking for a value of
...
(``not found''). Applying a filter to a search function will exclude
values from the search unless they satisfy an additional predicate.
...
We extend the definition of \lstinline!liftOpt! from Example~\ref{subsec:filt-solved-example-5}:
\begin{lstlisting}
