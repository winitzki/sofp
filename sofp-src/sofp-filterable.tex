...
The \index{unrolling trick for recursive types}\index{recursive types!unrolling trick}\textbf{unrolling
...
defines a \textbf{functor} more\index{functor!in category theory|textit}
generally \textemdash{} as a lawful lifting \emph{from one category
to another}. We will use the phrase \textsf{``}\textbf{categorical functor}\textsf{''}
to distinguish the notion of functor in category theory from the programmer\textsf{'}s
notion (a type constructor with \lstinline!map!.\footnote{In category theory, programmer\textsf{'}s functors are called \textbf{endofunctors}\index{endofunctor}
