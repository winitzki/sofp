...
containing  any values of type $A$ (or else the partial function
law will fail). The only alternative is to return a value of type
$Z$. But $Z$ is a type parameter, and we cannot create values of
type $Z$ from scratch. We conclude that $F^{Z,A}$ is not filterable
with respect to $A$.
\begin{lstlisting}
