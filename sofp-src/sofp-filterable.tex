...
\subsection{Motivation and laws for \texttt{liftOpt\label{subsec:Motivation-and-laws-for-liftopt}}}
...
called \index{Kleisli composition}\textbf{Kleisli composition}.\label{kleisli-composition}
It applies to functions such as $\psi_{p}$ that have type $A\rightarrow\bbnum 1+A$;
