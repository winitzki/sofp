...
\end{equation}
which follows directly from the definition of the pair product operation
$\boxtimes$,
\begin{align*}
...
(a type constructor with \lstinline!map!.\footnote{In category theory, programmer's functors are called \textbf{endofunctors}\index{endofunctor}\textemdash{}
