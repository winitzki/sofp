...
new monads $M$, we can look for \textsf{``}$M$-filterable\textsf{''} functors\index{$M$-filterable functors}
$F$ that admit an operation $\text{lift}_{M,F}$ that replaces $\text{liftOpt}_{F}$
