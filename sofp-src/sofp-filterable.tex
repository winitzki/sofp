...
Are \lstinline!deflate! and \lstinline!filter! computationally equivalent\index{computational equivalence!examples}?
...
Are these two functions computationally equivalent?\index{computational equivalence!examples}
...
via the natural transformation recipe. (A general recipe that works
