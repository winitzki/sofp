...
parametric implementation of $\text{liftOpt}_{S}$ (see the discussion
at the end of Section~\ref{subsec:Bifunctors}, as well as Appendix~\ref{app:Proofs-of-naturality-parametricity}).
