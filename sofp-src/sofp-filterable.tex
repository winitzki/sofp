...
filterable). The laws\index{identity laws!of liftOpt@of \texttt{liftOpt}}\index{composition law!of liftOpt@of \texttt{liftOpt}}
...
$\text{filt}_{C}$ as
\[
\text{filt}_{C}(p^{:A\rightarrow\bbnum 2})\bef(f^{:B\rightarrow A})^{\downarrow C}=f^{\downarrow C}\bef\text{filt}_{C}(f\bef p)\quad.
\]
...
and making changes suitable for contrafunctors, we obtain the \index{naturality law!for inflate@for \texttt{inflate}}\textbf{naturality
law} for the
...
\[
(f^{:B\rightarrow A})^{\downarrow C}\bef\text{inflate}_{C}=\text{inflate}_{C}\bef f^{\uparrow\text{Opt}\downarrow C}\quad.
\]
...
\end{lstlisting}
\begin{align*}
 & \text{liftOpt}_{F}(f^{:A\rightarrow\bbnum 1+B})\triangleq c^{:B\rightarrow\bbnum 1+H^{B}}\rightarrow a^{:A}\rightarrow a\triangleright f\triangleright\text{flm}_{\text{Opt}}(c)\triangleright\big(\text{liftOpt}_{H}(f)\big)^{\uparrow\text{Opt}}\\
 & =c\rightarrow f\bef\text{flm}_{\text{Opt}}(c)\bef\big(\text{liftOpt}_{H}(f)\big)^{\uparrow\text{Opt}}\quad.
\end{align*}
To verify the naturality-identity law~(\ref{eq:naturality-identity-law-filterable-contrafunctor}),
apply to an arbitrary $c^{:B\rightarrow\bbnum 1+H^{B}}$:
\begin{align*}
{\color{greenunder}\text{expect to equal }c\triangleright f^{\downarrow F}:}\quad & c\triangleright\text{liftOpt}_{F}(f\bef\text{pu}_{\text{Opt}})=f\bef\gunderline{\text{pu}_{\text{Opt}}\bef\text{flm}_{\text{Opt}}(c)}\bef\big(\text{liftOpt}_{H}(f\bef\text{pu}_{\text{Opt}})\big)^{\uparrow\text{Opt}}\\
{\color{greenunder}\text{use Eq.~(\ref{eq:simplify-puOpt-flmOpt})}:}\quad & =f\bef c\bef\big(\gunderline{\text{liftOpt}_{H}(f\bef\text{pu}_{\text{Opt}})}\big)^{\uparrow\text{Opt}}\\
{\color{greenunder}\text{law~(\ref{eq:naturality-identity-law-filterable-contrafunctor}) of }H:}\quad & =f\bef c\bef\big(f^{\downarrow H}\big)^{\uparrow\text{Opt}}=c\triangleright f^{\downarrow F}\quad.
\end{align*}

To verify the composition law~(\ref{eq:composition-law-filterable-contrafunctor}):
\begin{align*}
{\color{greenunder}\text{expect to equal }c\triangleright\text{liftOpt}_{F}(f\diamond_{_{\text{Opt}}}g):}\quad & c\triangleright\text{liftOpt}_{F}(g)\bef\text{liftOpt}_{F}(f)=\big(c\triangleright\text{liftOpt}_{F}(g)\big)\triangleright\gunderline{\text{liftOpt}_{F}(f)}\\
{\color{greenunder}\text{definition of }\text{liftOpt}_{F}(f):}\quad & =f\bef\text{flm}_{\text{Opt}}\big(\gunderline{c\triangleright\text{liftOpt}_{F}(g)}\big)\bef\big(\text{liftOpt}_{H}(f)\big)^{\uparrow\text{Opt}}\\
{\color{greenunder}\text{definition of }\text{liftOpt}_{F}(g):}\quad & =f\bef\text{flm}_{\text{Opt}}\gunderline{\big(g\bef\text{flm}_{\text{Opt}}(c)\bef(\text{liftOpt}_{H}(g))^{\uparrow\text{Opt}}\big)}\bef\big(\text{liftOpt}_{H}(f)\big)^{\uparrow\text{Opt}}\\
{\color{greenunder}\text{properties of }\text{flm}_{\text{Opt}}:}\quad & \gunderline{f\bef\text{flm}_{\text{Opt}}(g)}\bef\text{flm}_{\text{Opt}}(c)\bef\big(\gunderline{\text{liftOpt}_{H}(g)\bef\text{liftOpt}_{H}(f)}\big)^{\uparrow\text{Opt}}\\
{\color{greenunder}\text{definition~(\ref{eq:def-of-Kleisli-product}) of }f\diamond_{_{\text{Opt}}}g:}\quad & =(f\diamond_{_{\text{Opt}}}g)\bef\text{flm}_{\text{Opt}}(c)\bef\big(\text{liftOpt}_{H}(f\diamond_{_{\text{Opt}}}g)\big)^{\uparrow\text{Opt}}\\
{\color{greenunder}\text{definition of }\text{liftOpt}_{F}(f\diamond_{_{\text{Opt}}}g):}\quad & =c\triangleright\text{liftOpt}_{F}(f\diamond_{_{\text{Opt}}}g)\quad.
\end{align*}

Here we used the property of $\text{flm}_{\text{Opt}}$: {*}{*}{*}

\paragraph{Recursive types}

To define a contrafunctor via type recursion, we need to use a profunctor
$S^{A,R}$ that is contravariant in $A$ and covariant in $R$.
