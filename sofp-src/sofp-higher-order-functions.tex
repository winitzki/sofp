...
called \textsf{``}\textbf{\index{closure}closures}\textsf{''}. One could also  say
...
\begin{align*}
 ...
 & \left(x\rightarrow y\rightarrow x(x(y))\right)\bef\left(p\rightarrow p(2)+3\right)=x\rightarrow\left(y\rightarrow x(x(y))\right)(2)+3\\
