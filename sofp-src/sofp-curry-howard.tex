...
denoted using the symbol $\vdash$ (the \textsf{``}turnstile\textsf{''}):\index{vdash (turnstyle) symbol@$\vdash$ (turnstyle) symbol}\index{turnstile (vdash) symbol@turnstile ($\vdash$) symbol}
\begin{equation}
