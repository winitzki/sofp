...
\lstinline!f! has been already compiled and is ready to be used in
any subsequent code.
...
note that $g_{2}:\bbnum 1\Rightarrow\bbnum 1+A$ must have type signature\hfill{}~\begin{wrapfigure}{l}{0.4\columnwidth}%
...
in the code. The ``constructive\index{constructive logic}'' logic
