...
be available. So, it appears that the seven type constructions and
the eight code constructions (Sections~\ref{subsec:Type-notation-and-standard-type-constructions}
and~\ref{subsec:The-rules-of-proof}) will remain available in all
future languages of functional programming. 
