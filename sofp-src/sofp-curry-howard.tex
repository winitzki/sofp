...
eight code constructs\index{eight code constructions} are illustrated
...
of type $X$ must be a combination of some of the eight code constructs\index{eight code constructions},
...
function. That function's code may not decide what to do depending
...
are needed because the Scala compiler cannot know that $A=\text{Int}$
in the scope where we return \lstinline!Left(123)!. Without a type
cast, the compiler will not accept \lstinline!123! as a value of
type \lstinline!A! in that scope.
