...
an algorithm (the \textsf{``}\index{LJT algorithm}LJT algorithm\textsf{''}, see Section~\ref{app:The-LJT-algorithm}).
...
The LJT algorithm may find several inequivalent proofs of the same
logic formula. In that case, each of the different proofs will be
automatically translated into code. The \lstinline!curryhoward! library
tries to select the code that has the least information loss, according
to several heuristics. In many cases, the heuristics select the implementation
...
match. This mathematical guarantee (known as \index{type safety}\textbf{type
