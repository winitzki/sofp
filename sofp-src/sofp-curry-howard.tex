...
or C that denotes functions returning no values. Those functions are
equivalent to Scala functions returning the \lstinline!Unit! type.} (Scala\textsf{'}s \lstinline!Nothing!) corresponds to the logical constant
