...
and $g^{:\bbnum 0\rightarrow A}$. Are $f$ and $g$ different? We
would see that $f$ and $g$ are different only if we find a value
...
more precise terms ``polynomial'' and ``exponential-polynomial''.} The set of exponential-polynomial types covers almost all data types
...
parametric, it will work in the same way with any type $E$, including
...
fully parametric code that works the same way for all types $A$ (void
or not). But, as we have seen, this is impossible.
