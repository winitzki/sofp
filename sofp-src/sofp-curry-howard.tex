...
Type expressions that also contain function types may be called \textbf{exponential-polynomial}\index{exponential-polynomial type}\index{types!exponential-polynomial}.\footnote{Polynomial types are often called ``algebraic data types\index{algebraic data types}''.}
