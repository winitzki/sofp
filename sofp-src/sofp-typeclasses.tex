...
\index{argument group}argument group.
...
We must implement this type isomorphism as two functions, named e.g.~\lstinline!fix!
and \lstinline!unfix!, satisfying the conditions 
\[
...
Given a \lstinline!Monoid! instance, how can we recover the inherited
\lstinline!Semigroup! instance? We need to extract the implicit value
of type \lstinline!Semigroup[T]! that was passed to the \lstinline!Monoid!
class constructor. This is achieved by adding an implicit function
and by redefining the \lstinline!Monoid! class as follows,
\begin{lstlisting}
...
of the parent typeclass may be present. This will give a compile-time
error:
\begin{lstlisting}
