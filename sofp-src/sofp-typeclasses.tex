...
\end{lstlisting}
Although the \textbf{expanded form} of the function\index{expanded form of function!use in recursive values}''
...
definitions \index{recursive function!termination} terminate.
...
$S^{A,A}$. We call a bifunctor $S$ \textbf{co-pointed}\index{co-pointed bifunctor}\index{naturality law!for co-pointed bifunctor}
