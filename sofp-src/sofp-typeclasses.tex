...
\end{lstlisting}
In the Scala compiler, an instance argument such as \lstinline!ti: HasBitsize[T]!
is called an \textsf{``}evidence parameter\textsf{''}\index{evidence value} \index{typeclass!evidence parameter}
because it shows that the type \lstinline!T! belongs to the type
domain of the typeclass.
