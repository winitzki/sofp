...
not support that. The return type is required to be \lstinline!Pointed[L]!
where \lstinline!L! needs to be a type expression that defines a
type constructor, i.e.~a type-to-type function with a \emph{single}
type parameter. We cannot define a new type name (such as \lstinline!L!)
