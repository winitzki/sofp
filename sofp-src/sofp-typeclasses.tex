...
\caption{Full code for a recursive instance, using a \lstinline!trait! for
implementing the \lstinline!Monoid! typeclass. \label{fig:Implementation-of-Monoid-typeclass-with-trait}}
\end{figure}
