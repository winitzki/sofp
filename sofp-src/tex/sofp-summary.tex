...
and another for reading files. In the next few sections, we find that
the free monad is a natural result of making a type-safe DSL with
the ability to bind variables to results of previous DSL computations.

We show code implementing the two DSLs via the free monad, and give
examples of running DSL programs. {*}{*}{*}
