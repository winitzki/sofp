...
Let $T$ be the least fixpoint of a given polynomial functor $F$,
represented in the Church encoding as:
\[
T\triangleq\forall A.\ (F^{A}\rightarrow A)\rightarrow A\quad.
\]
Show that there exists an injective function of type $F^{\bbnum 0}\rightarrow T$
whose left inverse is a surjective function of type $T\rightarrow F^{\bbnum 0}$.
