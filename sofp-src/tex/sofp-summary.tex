...
\item We look back on various typeclass methods and laws defined in this
and the previous chapter, and generalize the patterns we find (see
Table~\ref{tab:functorial-typeclasses}). The laws of each typeclass
are equivalent to the standard laws of a certain categorical functor
defined in a suitable way for that typeclass. This provides a general
and abstract picture justifying the choice of typeclass laws in those
cases.
\end{itemize}
