...
we proceed to a structural analysis for filterable functors. In other
words, we attempt to discover all possible type constructions that
produce new filterable functors out of previously given ones. 
