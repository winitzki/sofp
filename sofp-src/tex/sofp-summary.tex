...
where an abstract version of the Yoneda identity (the \textsf{``}Yoneda lemma\textsf{''})
is proved for all categories. The most important applications of the
Yoneda lemma to programming are the two Yoneda identities involving
covariant and contravariant functors. Other applications used in this
book are Yoneda identities for type constructors (see Section~\ref{subsec:The-Yoneda-identities-for-type-constructors})
and for lawful $P$-typeclasses (used in Section~\ref{subsec:The-Jaskelioff-OConnor-theorem}
...
discovering various type constructors that are non-disjunctive. Some
