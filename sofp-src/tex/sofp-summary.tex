...
turns out that the corresponding runner is \textsf{``}universal\textsf{''} and works
in the same way for any target monad. We show how to implement a universal
runner for monadic DSLs.

{*}{*}{*}is that the monad laws are not
