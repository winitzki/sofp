...
A number of resulting type isomorphisms can be found in Tables~\ref{tab:Type-identities-proved-by-Yoneda}\textendash \ref{tab:Type-identities-for-existential-types}.
