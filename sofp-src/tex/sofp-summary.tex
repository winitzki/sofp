...
consider four different encodings of the free monoid (denoted by $F_{1}$,
$F_{2}$, $F_{3}$, $F_{4}$). We find that a free monoid encoding
can be injectively mapped into any other encoding that obeys \emph{fewer}
