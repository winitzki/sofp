...
\end{align*}
Here the operation $\diamond_{_{R}}$ is a special composition operation
defined by:
\begin{align*}
...
\]
These functions are assumed to be known, satisfy the naturality laws
with respect to $A$, and to be inverse to each other. Then the code
of $\text{liftOpt}_{F}$ is expressed through $\text{liftE}_{S}$
like this:
\begin{align*}
