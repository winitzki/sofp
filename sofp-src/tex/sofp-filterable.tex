...
based on a bifunctor $S$ as the recursion scheme.
...
In other words, the recursion scheme $S^{A,R}$ must be a profunctor\index{profunctor}\index{recursion scheme!being a profunctor}
