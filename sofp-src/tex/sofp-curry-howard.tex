...
\textbf{(i)} $A+Z\rightarrow B+Z\rightarrow(A\rightarrow B\rightarrow C)\rightarrow C+Z\quad.$

\textbf{(j)} $P+A\times A\rightarrow(A\rightarrow B)\rightarrow(P\rightarrow A+Q)\rightarrow Q+B\times B\quad.$

\textbf{(k)} $\text{Reader}^{E,A}\rightarrow(A\rightarrow\text{Reader}^{E,B})\rightarrow\text{Reader}^{E,B}\quad.$

\textbf{(l)} $\text{Reader}^{E,A}\times\text{Reader}^{E,B}\rightarrow(A\times B\rightarrow C)\rightarrow\text{Reader}^{E,C}\quad.$

\textbf{(m)} $\text{State}^{S,A}\rightarrow\left(S\times A\rightarrow B\right)\rightarrow\text{State}^{S,B}\quad.$
