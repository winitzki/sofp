\onecolumn
\thispagestyle{empty}
\newgeometry{top=2.5cm, left=2.5cm, right=3.9cm,bottom=2.5cm}
...
%\vspace{2.0cm}\hspace*{\fill}\colorbox{white}{\includegraphics[scale=1.0,width=50.8mm,height=30.5mm]{barcode}}
