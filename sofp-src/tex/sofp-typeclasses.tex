...
\[
\text{Arr}\triangleq\text{Array}_{0}^{A}+\text{Array}_{1}^{A}+\text{Array}_{2}^{A}+...\quad,
\]
...
types:
\[
f_{1}:\text{Arr}\rightarrow\text{List}^{A}\quad,\quad\quad f_{2}:\text{List}^{A}\rightarrow\text{Arr}\quad,
\]
