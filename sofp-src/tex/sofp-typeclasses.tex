...
be written as $A\rightarrow P^{A}$ with some functor $P$. Examples
are \textsf{``}extractor\textsf{''} typeclasses (e.g., \lstinline!Show!) and \lstinline!Traversable!
functors (Chapter~\ref{chap:9-Traversable-functors-and}). Based
