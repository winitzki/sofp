...
\subsubsection{Exercise \label{subsec:tc-Exercise-9-1-1-1}\ref{subsec:tc-Exercise-9-1-1-1}\protect\footnote{This property is dual to O\textsf{'}Connor\textsf{'}s pointed functor property from
