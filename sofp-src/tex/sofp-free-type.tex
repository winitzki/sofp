...
a type denoted by $\mu A.\,F^{A}$ such that for any other fixpoint
$U$ there exists a fixpoint-preserving function of type $(\mu A.\,F^{A})\rightarrow U$.
The \textbf{greatest fixpoint} of the same type equation is a type
denoted by $\nu A.\,F^{A}$ such that for any other fixpoint $U$
there exists a fixpoint-preserving function of type $U\rightarrow\nu A.\,F^{A}$.
$\square$
