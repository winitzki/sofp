...
parametic code. To see why, consider that code working with values
...
It follows from the strong dinaturality law\footnote{\index{Dan Doel}Dan Doel gave a proof of this statement using relational
