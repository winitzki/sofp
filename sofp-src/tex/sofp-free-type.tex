...
evaluator that transform a free typeclass value into a value of an
arbitrary other type belonging to the same typeclass. For instance,
the universal runner for the free monad \lstinline!MonadDSL! takes
any other monad $M$ and a polymorphic function of type $\forall T.\,F^{T}\rightarrow M^{T}$
...
The universal runner can be expressed through the free evaluator and
vice versa.
