...
can be simplified to just \lstinline!NEL[T]! because the nested \lstinline!Wrap!
is a trivial case class that carries no functionality by itself. 
...
automatically. The free evaluator becomes:
\begin{lstlisting}
