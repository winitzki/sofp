...
\lstinline!List[A]!. To see this formally, we need to find a function
that embeds values of type \lstinline!List[A]! into the type \lstinline!ListC[A]!
in a way that preserves the fixpoint structure of those types. 

{*}{*}{*}

transform $f_{1}:L_{\text{fin}}^{A}\rightarrow L^{A}$ and $f_{2}:L_{\text{inf}}^{A}\rightarrow L^{A}$.
