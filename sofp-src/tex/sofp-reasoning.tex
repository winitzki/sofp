...
This book\textsf{'}s notation for types and code is designed to make symbolic
reasoning and derivations simpler to discover and to read. The notation
is \emph{non-standard} in some important aspects: notably, type parameters
are written as superscripts, and matrices are used for functions working
with co-product types. This section presents a systematic motivation
and overview of the code notation.

\subsection{The nine constructions of fully parametric code}

The eight basic constructs\index{eight code constructs} introduced
