...
a \textbf{nondegeneracy law}:\footnote{This law holds automatically as long as both \lstinline!flift! and
...
This concludes the proof of monad transformer laws for the monad $R\triangleq P\varangle Q$.
So, the monad transformer for $R$ defined by $R\varangle M\triangleq P\varangle(Q\varangle M)$
