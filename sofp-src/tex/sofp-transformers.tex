...
defined parametrically in the monad $M$. We will show later that
the base runner always satisfies a \textbf{nondegeneracy law}:\index{nondegeneracy law!of base runners (brun)@of base runners (\texttt{brun})}
\[
...
with respect to the monads $L$, $M$. Also, the type $T_{L}^{M,A}$
