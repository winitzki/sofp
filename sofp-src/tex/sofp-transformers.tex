...
$M$ is also fixed, we will denote $T_{\text{Free}}^{M,A}$ simply
by $T^{A}$.
...
to express $T_{\text{Free}}$ through previously known types. Write
...
where $F$ and $G$ are two functors. Then the monad stack of $\text{Free}^{F}$
and $\text{Free}^{G}$ is equivalent (as type) to the monad $\text{Free}^{F+G}$.
In the monad stack notation:
\[
...
and obtain:
\begin{align*}
{\color{greenunder}\text{recursive definition of }U^{A}:}\quad & U^{A}=\text{Free}^{G,A+F^{U^{A}}}\quad.
\end{align*}
To simplify this type further, we substitute the definition of $\text{Free}^{G}$
and write:
\begin{align*}
...
{\color{greenunder}\text{use the above recursive definition of }U^{A}:}\quad & =A+F^{U^{A}}+G^{U^{A}}\\
{\color{greenunder}\text{define }H^{A}\triangleq F^{A}+G^{A}:}\quad & =A+H^{U^{A}}\quad.
\end{align*}
We found that $U^{A}$ satisfies the same type equation as $\text{Free}^{F+G,A}$.
$\square$
