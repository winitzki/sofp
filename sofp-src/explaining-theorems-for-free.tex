...
\item For any \lstinline!f: A => B!, applying \lstinline!t[A]: F[A] => G[A]!
\emph{before} \lstinline!_.map(f)! equals applying \lstinline!t[B]: F[B] => G[B]!
\emph{after} \lstinline!_.map(f)!
\[
\xymatrix{\xyScaleY{2.8pc}\xyScaleX{5.5pc}\mathtt{F[A]}\ar[d]\sb(0.5){~\mathtt{\_.map(f)}}\ar[r]\sp(0.5){\mathtt{t[A]}} & \mathtt{G[A]}\ar[d]\sp(0.5){\mathtt{\_.map(f)}}\\
