...
=> G{[}A{]}}}~\\
\texttt{\textcolor{blue}{\small{}fmap\_F(f) = (p:~G{[}A{]} => H{[}A{]})
=> (gb:~G{[}B{]}) => fmap\_H(f)(p(cmap\_G(f)(gb))}}{\small\par}
...
\begin{frame}{Step 3. Relation combinators}

Given two relations \texttt{\textcolor{blue}{\small{}r:~A <=> B}}
and \texttt{\textcolor{blue}{\small{}s:~X <=> Y}}, we define:
\begin{itemize}
...
\begin{frame}{Example: applying relational parametricity to $\forall A.\,A\rightarrow A$}
...
\begin{frame}{Step 5. Formulation of relational parametricity law}
...
rmap\_P(r)}}{\small\par}
\item Any fully parametric \texttt{\textcolor{blue}{\small{}t:~P}} satisfies
\texttt{\textcolor{blue}{\small{}(t, t) in rmap\_P(id)}}{\small\par}
\item This is the formulation shown in some papers: if $t:P$ then $(t,t)\in\tilde{P}$
\end{itemize}
...
in pmap(rmap\_Q(r), rmap\_P(r))}}{\small\par}
\end{itemize}
...
\begin{frame}{Step 5. Outline of the proof of the relational law}
...
\begin{frame}{Step 5. First 4 inductive cases of the proof}

Constant type: \texttt{\textcolor{blue}{\small{}t{[}A{]}(z) = c}}
where \texttt{\textcolor{blue}{\small{}c:~C}} with a fixed type \texttt{\textcolor{blue}{\small{}C}}:
\begin{itemize}
...
\texttt{\textcolor{blue}{\small{}z}} is a value of type \texttt{\textcolor{blue}{\small{}Q{[}A{]}}}:
\begin{itemize}
...
\begin{frame}{Step 5. Next 4 inductive cases of the proof}
...
\begin{frame}{Step 6. From relational parametricity to the wedge law}
