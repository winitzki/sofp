...
\item The type\texttt{\textcolor{blue}{\small{} CT}} is the least fixpoint
of the equation \texttt{\textcolor{blue}{\small{}T $\cong$ S{[}T{]}}}{\small\par}
\begin{itemize}
\item This is proved in Wadler's paper ``\href{https://homepages.inf.ed.ac.uk/wadler/papers/free-rectypes/free-rectypes.txt}{Recursive types for free}''
(1990)
\begin{itemize}
\item ... by using a relational naturality law that is not derived there
\end{itemize}
\end{itemize}
\item Implement the \texttt{\textcolor{blue}{\small{}fix}} and \texttt{\textcolor{blue}{\small{}unfix}}
methods for \texttt{\textcolor{blue}{\small{}CT}}:
\end{itemize}
...
\texttt{\textcolor{blue}{\small{}def unfix(ct:~CT):~S{[}CT{]} =}}{\small\par}
\begin{itemize}
\item Need relational parametricity to prove the isomorphism
\end{itemize}
\end{frame}
...
\end{itemize}
\end{itemize}
\item Relational law of \texttt{\textcolor{blue}{\small{}u:~CT}} is: for
...
\texttt{\textcolor{blue}{\small{}(u{[}A{]}(p), u{[}B{]}(q)) in r}}{\small\par}
\begin{itemize}
...
q}} then we will have \texttt{\textcolor{blue}{\small{}f(u{[}A{]}(p))
== u{[}B{]}(q)}}{\small\par}
\item Choose \texttt{\textcolor{blue}{\small{}{*}{*}{*}A = B = CT}}, \texttt{\textcolor{blue}{\small{}B
= S{[}CT{]}}}, \texttt{\textcolor{blue}{\small{}f = unfix}}, \texttt{\textcolor{blue}{\small{}p
= fix}}, \texttt{\textcolor{blue}{\small{}q = fmap\_S(fix)}}{\small\par}
\item \texttt{\textcolor{blue}{\small{}Then the relational law}}{\small\par}
\end{itemize}
\end{itemize}
\end{frame}
