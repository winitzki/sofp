...
\begin{frame}{Step 4. Examples of using \texttt{rmap}}

Consider \texttt{\textcolor{blue}{\small{}P{[}A{]} = R => (A, A)}}
where \texttt{\textcolor{blue}{\small{}R}} is a fixed type

Define \texttt{\textcolor{blue}{\small{}fmap\_P}} and \texttt{\textcolor{blue}{\small{}rmap\_P}}
by using their inductive definitions
...
Examples of type constructors of different complexity:
\begin{itemize}
...
\item Also need to prove that \texttt{\textcolor{blue}{\small{}rmap2(r,
id) = rmap(r)}} etc.
\end{itemize}
