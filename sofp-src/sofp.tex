...
% Support conditional compilation for a 2-volume edition.
\newif\singlevolume%
\newif\volumeone%
\newif\volumetwo%
\singlevolumetrue%
...
\subtitle{A Tutorial, with Examples in Scala\ifsinglevolume\relax\else\ifvolumeone .
Volume 1\fi\ifvolumetwo . Volume 2\fi\fi }
\author{by Sergei Winitzki, Ph.D.}
\date{Draft version of \today}
\publishers{Published \ifsinglevolume by\textbf{ \href{http://lulu.com}{lulu.com}}\fi 
in 2020}
...
\fi ~\\
ISBN: \ifsinglevolume 978-0-359-76877-6\else ???\fi\\
\\
{\scriptsize{}Source hash: a34ba582f07bce5555bb8930bb0d799181ec67dcfaa2ca4eceb6ca20e63072ab}\\
{\scriptsize{}Git commit: 5e1acdd83ed7708daa4f59a2cec285352e2be1c2}\\
~\\
...
code may be also included as a \textsf{``}file attachment\textsf{''} }\texttt{\scriptsize{}sofp-src.tar.bz2}{\scriptsize{}
