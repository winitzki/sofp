...
\lowertitleback{This book is a pedagogically developed in-depth tutorial on functional
programming. Starting from problems encountered in practical coding,
the book builds the theoretical intuition and knowledge needed by
practitioners of the functional programming paradigm.\\
The topics include working with collections; recursive functions and
types; the fundamental type and code constructions in functional programming;
...
and other important typeclasses; and free type constructions.\\
Long and difficult, yet boring explanations are logically developed
in excruciating detail and accompanied by full step-by-step derivations
...
able to write code that reads a small text file and prints the number
of words in it. The mathematical difficulty of derivations in this
book is at the level of high-school mathematics, similar to simplifying
the expressions
\[
