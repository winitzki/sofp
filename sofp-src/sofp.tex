...
\\
{\footnotesize{}Source hash: 06d9092e2f2c3d60ed151d724f2e58d3cb4cc4128ae02f927463088fa21a1c90}\\
{\footnotesize{}Git commit: 1c8efb39e3f84a940cf6ca3f1d9bfb5a20bd0d84}\\
~\\
...
\\
Beginners in functional programming will find clear explanations about
the \inputencoding{latin9}\lstinline!map!\inputencoding{utf8} / \inputencoding{latin9}\lstinline!reduce!\inputencoding{utf8}
...
of the Curry-Howard correspondence; proves that the implementations
of all the standard monads (e.g.~\inputencoding{latin9}\lstinline!State!\inputencoding{utf8}
or \inputencoding{latin9}\lstinline!Continuation!\inputencoding{utf8})
satisfy the monad laws; derives lawful instances of \inputencoding{latin9}\lstinline!Functor!\inputencoding{utf8}
...
the “tagless final” and the “free functor” constructions; and proves
the parametricity theorem without unnecessary jargon.\\
\\
