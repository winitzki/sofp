...
\geometry{verbose,tmargin=0.95cm,bmargin=1.5cm,lmargin=2.1cm,rmargin=1.4cm,headsep=0.4cm,footskip=0.75cm}
...
morekeywords={[2]{String,Int,Long,Char,Boolean,Double,Float,BigDecimal,Seq,Map,Set,List,Option,Either,Future,Vector,Range,IndexedSeq,Try,true,false,None,Some,Left,Right,Nothing,Any,Array,Unit,Iterator,Stream}},
...
as well as exercises. Readers should have a working knowledge of basic
Scala; e.g.\ be able to write code that reads a small text file and
prints the number of words in it. Readers should also know school-level
