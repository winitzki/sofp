...
%\endalign\end{empheq}}
% Run a command such as LC_ALL=C sed -i bak -e 's|\\begin{empheq}[box=\mymathbgbox]{align}|\\begin{empheq}[box=\\mymathbgbox]{align}|; s|\\end{empheq}|\\end{empheq}|' sofp-filterable.tex
...
~\\
%Published by~ \textbf{\href{http://lulu.com}{lulu.com}}\\
~\\
...
the number of words in it. Readers should also know school-level mathematics;
for example, should be able to simplify the expressions $\frac{1}{x-2}-\frac{1}{x+2}$
