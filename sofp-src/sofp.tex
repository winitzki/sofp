...
\documentclass[12pt,russian,english,cleardoubleempty,openright,numbers=noenddot,index=totoc,bibliography=totoc,listof=totoc,fontsize=12pt]{scrbook}
\usepackage{amsmath}
\usepackage{mathpazo}
\usepackage{helvet}
...
\renewcommand*{\subsubsectionformat}{abcd}
...
\\
{\scriptsize{}Source hash (sha256): 9b8eee470e12b6241941f4352b57b17719bc32db879c65bab79b40446b261355}\\
{\scriptsize{}Git commit: 8ed55331e713c716d4c897ad7312a72dd01efc2c}\\
{\scriptsize{}PDF file built on Fri, 29 Mar 2024 13:14:23 +0100 by pdfTeX 3.141592653-2.6-1.40.25 (TeX Live 2023) on Darwin}\\
~\\
...
\textsf{``}GNU Free Documentation License\textsf{''} (Appendix~\ref{sec:GFDL} on page~\pageref{sec:GFDL}).}\\
{\scriptsize{}~}\\
...
developed in excruciating detail through 1882 Scala
code snippets, 191 statements with step-by-step derivations,
103 diagrams, 218 examples with tested Scala
