...
\documentclass[10pt,russian,english,numbers=noenddot,index=totoc,bibliography=totoc,listof=totoc,fontsize=12pt]{scrbook}
\usepackage{amsmath}
\usepackage{mathpazo}
\usepackage{helvet}
...
\\
{\scriptsize{}Source hash (sha256): 9ca41a6d740b04a655ae6f704298d5879538830ac7d1ebcf5a617c777a138132}\\
{\scriptsize{}Git commit: e187fc2900112880c86f4d842b97462b6dd13bfd}\\
{\scriptsize{}PDF file built on Thu, 07 Mar 2024 21:25:53 +0100 by pdfTeX 3.141592653-2.6-1.40.25 (TeX Live 2023) on Darwin}\\
~\\
...
developed in excruciating detail through 1879 Scala
code snippets, 191 statements with step-by-step derivations,
103 diagrams, 216 examples with tested Scala
code, and 296 exercises. Discussions build upon each
