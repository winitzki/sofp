...
morekeywords={[2]{String,Short,Int,Long,Char,Boolean,Double,Float,BigDecimal,Seq,Map,Set,List,Option,Either,Future,Vector,Range,IndexedSeq,Try,true,false,None,Nil,Some,Left,Right,Nothing,Any,Array,Unit,Iterator,Stream}},
...
\\
{\scriptsize{}Source hash: f415688f92f7302bd052a64ce1b011684f6072c9d12203babfba07cabf08ea32}\\
{\scriptsize{}Git commit: 42a7c78ab8e9085e49027d9d8076081cbb08504f}\\
~\\
...
on the functional programming paradigm as practiced in the early 21$^{\text{st}}$
...
code.}\\
{\small{}}\\
{\small{}The book's topics include working with collections; recursive
...
of symbolic derivation and proof; parametricity; and free type constructions.}\\
{\small{}}\\
...
well as exercises and discussions that further build upon each chapter's
material.}\\
{\small{}}\\
{\small{}Beginners in functional programming will find clear explanations
about the }\inputencoding{latin9}\lstinline!map!\inputencoding{utf8}{\small{}
/ }\inputencoding{latin9}\lstinline!reduce!\inputencoding{utf8}{\small{}
...
of all the standard monads (e.g.~}\inputencoding{latin9}\lstinline!State!\inputencoding{utf8}{\small{}
...
{\small{}}\\
{\small{}Readers should have a working knowledge of programming; e.g.\ be
...
{\small{}This is Sergei Winitzki's fourth book. He received a Ph.D.
in theoretical physics and, after a career in academic research, currently
