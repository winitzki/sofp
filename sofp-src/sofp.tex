...
\newcommand{\insertmycoverpage}{\CenterWallPaper{1.0}{../cover/lulu-cover-background.jpg}%
\begin{textblock*}{5cm}(10cm,6cm)%
\fontsize{26pt}{28pt}\selectfont{The Science of Functional Programming}%
\end{textblock*}\clearpage{}\ClearWallPaper}
...
\begin{document}
\extratitle{\insertmycoverpage\hfill{}The Science of Functional Programming\hspace{1in}}
...
\\
{\scriptsize{}Source hash (sha256): INSERTSOURCEHASH}\\
{\scriptsize{}Git commit: INSERTGITCOMMIT}\\
{\scriptsize{}PDF file built by PDFTEXVERSION on BUILDDATE by BUILDOPERATINGSYSTEM}\\
~\\
...
“GNU Free Documentation License” (Appendix~\ref{sec:GFDL}).}\\
{\scriptsize{}~}\\
{\scriptsize{}A }\emph{\scriptsize{}Transparent}{\scriptsize{} copy
of the source code for the book is available at }\texttt{\scriptsize{}\href{https://github.com/winitzki/sofp/releases}{https://github.com/winitzki/sofp/releases}}{\scriptsize{}
...
under ``Assets'' as }\texttt{\scriptsize{}sofp.pdf}{\scriptsize{}
or }\texttt{\scriptsize{}sofp-draft.pdf}{\scriptsize{}. The source
code may be also included as a ``file attachment'' named }\texttt{\scriptsize{}sofp-src.tar.bz2}{\scriptsize{}
...
- Rewrite the appendix about parametricity, using strong dinaturality
instead of ordinary dinaturality. Do the proofs become easier? Will
we be able to avoid unproven steps?
...
- Need sections on MTL and on monad recursion (? or cut the scope).
