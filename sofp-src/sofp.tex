...
The book covers functional collections and recursion; the fundamental
type and code constructions in functional programming; reasoning about
types and code with the Curry-Howard correspondence; laws, structure
theorems, and code derivation for functors, monads, and other important
typeclasses; free type constructions; and recursive types.\\
...
\]
This is the fourth book written by Sergei Winitzki. He received a
Ph.D.~degree in theoretical physics and, after a career in academic
research, currently works as a software engineer.}
