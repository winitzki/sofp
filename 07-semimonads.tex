...
other left arrows
\item Container must have both \texttt{\textcolor{blue}{\footnotesize{}map}}
(i.e.\ be a functor) and \texttt{\textcolor{blue}{\footnotesize{}flatMap}} 
\begin{itemize}
...
...).flatten}} 
\end{itemize}
\item \texttt{\textcolor{blue}{\footnotesize{}flatten:\ F{[}F{[}A{]}{]}$\Rightarrow$F{[}A{]}}}
can be expressed through \texttt{\textcolor{blue}{\footnotesize{}flatMap}}
as well:
\begin{itemize}
...
are ``squashable'' or \textbf{semimonads}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item The number of resulting data items is $m*n*p$\texttt{\textcolor{blue}{\footnotesize{} }}{\footnotesize \par}
\begin{itemize}
...
\textendash{} can hold $0$ or $1$ elements
\item ``Tree-like'' containers, e.g.\ binary tree (holds $1$, $2$,
$4$, $8$, $16$, ...\ elements)
...
\end{itemize}
A schematic example of a functor block program using the \texttt{\textcolor{blue}{\footnotesize{}Try}}
functor:
\begin{lyxcode}
...
\end{lyxcode}
\begin{itemize}
\item This ``flat'' code replaces a long chain of nested \texttt{\textcolor{blue}{\footnotesize{}if/else}}
or \texttt{\textcolor{blue}{\footnotesize{}match/case}}{\footnotesize \par}
\begin{itemize}
\item Computations are sequential (also when using the \texttt{\textcolor{blue}{\footnotesize{}Future}}
functor!) 
\end{itemize}
\end{itemize}
\end{frame}
...
\item lift $f^{A\Rightarrow B}$ to Kleisli$_{\text{Opt}}$ow B}$ to Kleisli$_{\text{Opt}}$ by defining
