...
\item Define a disjunction type \texttt{\textcolor{blue}{\footnotesize{}RootOfQuadratic}}
that represents real-valued roots of the equation $x^{2}+bx+c=0$
for arbitrary real $b$, $c$. (The cases of interest are: no real
roots; two equal roots; two unequal roots.) Implement the solution
\texttt{\textcolor{blue}{\footnotesize{}((Double, Double)) $\Rightarrow$
RootOfQuadratic}}.
\item Implement a function \texttt{\textcolor{blue}{\footnotesize{}rootAverage:\ RootOfQuadratic
$\Rightarrow$ Option{[}Double{]}}} that represents the average value
of any real roots, returning \texttt{\textcolor{blue}{\footnotesize{}None}}
