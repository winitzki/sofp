...
\begin{itemize}
\item $\text{bop}\left(x\Rightarrow p_{1}(x)\wedge p_{2}(x)\right)$$=x^{A}\Rightarrow\left(\text{bop}\,p_{1}\right)(x)\text{.flatMap}\left(\text{bop}\,p_{2}\right)$}\left(\text{bop}\,p_{2}\right)$
