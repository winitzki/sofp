...
\textrm{\textcolor{gray}{\footnotesize{}//~for~}}\textcolor{gray}{\footnotesize{}F~=~Seq}\textrm{\textcolor{gray}{\footnotesize{},~this~would~be~}}\textcolor{gray}{\footnotesize{}foa.collect~\{~case~Some(x)~$\Rightarrow$ct~\{~case~Some(x)~$\Rightarrow$~x~\}}{\footnotesize \par}
