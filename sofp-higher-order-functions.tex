...
Note that the prefix is ``baked into'' the functions created by
...
the other if necessary. One can say that a curried function is \index{computational equivalence}\textbf{computationally
