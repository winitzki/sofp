...
\end{lyxcode}
\begin{itemize}
\item to use PTFs safely, we need to restrict their \emph{type} \emph{parameters}
to a subset
\end{itemize}
\end{itemize}
\end{frame}
...
is undefined
\item Define a monoid instance for the type $1+\left(\text{String}\Rightarrow\text{String}\right)$\Rightarrow\text{String}\right)$
