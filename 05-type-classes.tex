...
\begin{itemize}
\item We cannot add other PTVFs later
\end{itemize}
\end{itemize}
\end{itemize}
\end{frame}
...
(\textbf{evidence}) to \texttt{\textcolor{blue}{\footnotesize{}func{[}T{]}}}{\footnotesize \par}
...
\begin{itemize}
\item There is a special, somehow ``naturally'' selected value of that
type
\begin{itemize}
...
returns $64$, and undefined on other types
