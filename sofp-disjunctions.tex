...
To understand more deeply the properties of disjunctive types, let
us look at the mathematical description of functions.
...
analogy with a mathematical disjunctive between the two domains and
...
type either of string and integer which is a disjunctive between two
...
disjunctive so this is a possible value with symbol left and a number
...
this for in this code we enumerate the possible cases the disjunctive
there are only two cases in this disjunctive the left and the right
and so we enumerate them and each time we have a pattern variable
of a different type because if we are in the left case of disjunctive
