...
Examples and constructions of rigid monads (see code):
\begin{itemize}
...
\item The selector monad $S^{A}\equiv F^{A\Rightarrow R^{Q}}\Rightarrow R^{A}$
...
\item {\small{}Show that ed functor $P$.}{\small\par}
