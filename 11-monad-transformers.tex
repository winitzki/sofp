...
\begin{itemize}
\item {\footnotesize{}\vspace{-0.2cm}}``Nested'' associativity law: $\text{flm}_{R}g^{:A\Rightarrow R^{M^{B}}}=\text{pure}_{M}^{\uparrow R}\bef\text{flm}_{T}g^{:A\Rightarrow R^{M^{B}}}$
\end{itemize}
...
a monad when $M_{1}^{A}\equiv1+A$ and $M_{2}^{A}\equiv Z\Rightarrow A${1}^{A}\equiv1+A$ and $M_{2}^{A}\equiv Z\Rightarrow A$.}{\small\par}
