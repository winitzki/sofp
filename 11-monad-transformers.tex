...
\end{enumerate}
\item Use ``compatibility laws'': for any monad $M$, denoting $T^{\bullet}\equiv R^{M^{\bullet}}${\footnotesize{},\vspace{-0.1cm}
\[
\text{flm}_{R}f^{:A\Rightarrow R^{M^{B}}}=\text{pure}_{M}^{\uparrow R}\bef\text{flm}_{T}f^{:A\Rightarrow R^{M^{B}}}\quad\quad\left(\text{flm}_{M}f^{:A\Rightarrow M^{B}}\right)^{\uparrow R}=\text{pure}_{R}^{\uparrow T}\bef\text{flm}_{T}\left(f^{\uparrow R}\right)
\]
\vspace{-0.55cm}
\[
\xymatrix{R^{A}\ar[rr]\sp(0.5){\text{flm}_{R}f^{:A\Rightarrow R^{M^{B}}}}\ar[rd]\sb(0.4){\text{pure}_{M}^{\uparrow R}} &  & R^{M^{B}} &  & R^{M^{A}}\ar[rr]\sp(0.5){\left(\text{flm}_{M}f\right)^{\uparrow R}}\ar[rd]\sb(0.4){\text{pure}_{R}^{\uparrow T}} &  & R^{M^{B}}\\
\xyScaleY{1pc}\xyScaleX{2pc} & R^{M^{A}}\ar[ru]\sb(0.7){\text{flm}_{T}f^{:A\Rightarrow R^{M^{B}}}} &  &  &  & R^{M^{R^{A}}}\ar[ru]\sb(0.6){\text{flm}_{T}\left(f^{\uparrow R}\right)}
}
\]
}{\footnotesize\par}
\end{itemize}
