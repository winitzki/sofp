...
or $M_{2}^{M_{1}^{A}}$then one of $M_{1}^{M_{2}^{A}}$
...
\item Combine \texttt{\textcolor{blue}{\footnotesize{}Z $\Rightarrow$ A}}
and \texttt{\textcolor{blue}{\footnotesize{}List{[}A{]}}} as \texttt{\textcolor{blue}{\footnotesize{}Z
$\Rightarrow$ List{[}A{]}}} 
